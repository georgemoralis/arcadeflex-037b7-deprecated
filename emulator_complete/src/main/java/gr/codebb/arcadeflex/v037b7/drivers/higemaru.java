...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.higemaru.*;
import static gr.codebb.arcadeflex.vidhrdw.generic.*;

public class higemaru {

  public static InterruptPtr higemaru_interrupt =
      new InterruptPtr() {
        public int handler() {
          if (cpu_getiloops() == 0) {
  ...
  static InputPortPtr input_ports_higemaru =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_higemaru =
      new MachineDriver(
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_higemaru =
      new RomLoadPtr() {
        public void handler() {
  ...
  public static GameDriver driver_higemaru =
      new GameDriver(
          "1984",
          "higemaru",
          "higemaru.java",
