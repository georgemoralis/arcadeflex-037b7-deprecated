...
import static gr.codebb.arcadeflex.mame.palette.palette_recalc;
...
public class bombjack {
  ...
  public static WriteHandlerPtr bombjack_background_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr bombjack_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr bombjack_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = spriteram_size[0] - 4; offs >= 0; offs -= 4) {
            ...
            */
            ...
            drawgfx(
                bitmap,
                Machine.gfx[(spriteram.read(offs) & 0x80) != 0 ? 3 : 2],
