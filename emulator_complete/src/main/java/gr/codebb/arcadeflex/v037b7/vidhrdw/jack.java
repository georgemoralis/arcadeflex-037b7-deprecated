...
public class jack {
  ...
  public static WriteHandlerPtr jack_paletteram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr jack_flipscreen_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr jack_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          flip_screen_w.handler(0, offset);
        }
  ...
  public static VhUpdatePtr jack_vh_screenrefresh =
      new VhUpdatePtr() {
