...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.mrjong.*;
...
public class mrjong {
  ...
  public static WriteHandlerPtr io_0x00_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr io_0x03_r =
      new ReadHandlerPtr() {
  ...
  static InputPortPtr input_ports_mrjong =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static GfxLayout spritelayout =
      new GfxLayout(
          ...
          new int[] {
            ...
            8 * 8 + 7, /* pretty straightforward layout */ 0, 1, 2, 3, 4, 5, 6, 7
          },
          new int[] {
            23 * 8, 22 * 8, 21 * 8, 20 * 8, 19 * 8, 18 * 8, 17 * 8, 16 * 8, 7 * 8, 6 * 8, 5 * 8,
            4 * 8, 3 * 8, 2 * 8, 1 * 8, 0 * 8
          },
  ...
  static MachineDriver machine_driver_mrjong =
      new MachineDriver(
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80,
          ...
          32 * 8,
          32 * 8,
          new rectangle(0 * 8, 30 * 8 - 1, 2 * 8, 30 * 8 - 1),
          gfxdecodeinfo,
          16,
          4 * 32,
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_SN76496, /* SN76489 x2 */ sn76496_interface)});
  ...
  static RomLoadPtr rom_crazyblk =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* code */
  ...
  public static GameDriver driver_mrjong =
      new GameDriver(
          "1983",
          "mrjong",
          "mrjong.java",
          rom_mrjong,
          null,
          machine_driver_mrjong,
          input_ports_mrjong,
          null,
          ROT90,
          "Kiwako",
          "Mr. Jong (Japan)");
  public static GameDriver driver_crazyblk =
      new GameDriver(
          "1983",
          "crazyblk",
          "mrjong.java",
