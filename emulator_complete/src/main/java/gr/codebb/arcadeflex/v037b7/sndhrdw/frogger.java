...
public class frogger {
  ...
  static int clock;
  public static ReadHandlerPtr frogger_portB_r =
      new ReadHandlerPtr() {
  ...
  static int last_1;
  public static WriteHandlerPtr frogger_sh_irqtrigger_w =
      new WriteHandlerPtr() {
  ...
  static int last_2;
  public static WriteHandlerPtr frogger2_sh_irqtrigger_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
