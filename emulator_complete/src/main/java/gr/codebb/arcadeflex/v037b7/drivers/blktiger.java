...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.blktiger.*;
...
public class blktiger {
  ...
  public static ReadHandlerPtr blktiger_protection_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr blktiger_bankswitch_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr blktiger_coinlockout_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  static InputPortPtr input_ports_blktiger =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  public static WriteYmHandlerPtr irqhandler =
  ...
  static MachineDriver machine_driver_blktiger =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 4000000, /* 4 MHz (?) */ readmem, writemem, readport, writeport, interrupt,
                1),
            new MachineCPU(
                ...
                null,
                ignore_interrupt,
                0 /* IRQs are triggered by the YM2203 */)
          },
          60,
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_blktiger =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_bktigerb =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x50000, REGION_CPU1); /* 64k for code + banked ROMs images */
  ...
  static RomLoadPtr rom_blkdrgon =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x50000, REGION_CPU1); /* 64k for code + banked ROMs images */
  ...
  static RomLoadPtr rom_blkdrgnb =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x50000, REGION_CPU1); /* 64k for code + banked ROMs images */
  ...
  public static GameDriver driver_blktiger =
      new GameDriver(
          "1987",
          "blktiger",
          "blktiger.java",
          rom_blktiger,
          null,
          machine_driver_blktiger,
          input_ports_blktiger,
          null,
          ROT0,
          "Capcom",
          "Black Tiger");
  public static GameDriver driver_bktigerb =
      new GameDriver(
          "1987",
          "bktigerb",
          "blktiger.java",
          ...
          "bootleg",
          "Black Tiger (bootleg)");
  public static GameDriver driver_blkdrgon =
      new GameDriver(
          "1987",
          "blkdrgon",
          "blktiger.java",
          ...
          "Capcom",
          "Black Dragon");
  public static GameDriver driver_blkdrgnb =
      new GameDriver(
          "1987",
          "blkdrgnb",
          "blktiger.java",
