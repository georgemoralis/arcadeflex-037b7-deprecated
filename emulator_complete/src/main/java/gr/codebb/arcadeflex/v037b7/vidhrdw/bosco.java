...
public class bosco {
  ...
  static rectangle spritevisiblearea = new rectangle(0 * 8 + 3, 28 * 8 - 1, 0 * 8, 28 * 8 - 1);
  ...
  public static VhConvertColorPromPtr bosco_vh_convert_color_prom =
      new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < 64 * 4; i++) {
            ...
            colortable[i + 64 * 4] =
                (char) (15 - (color_prom.read(i + 32) & 0x0f) + 0x10); /* sprites */
  ...
  public static VhStartPtr bosco_vh_start =
      new VhStartPtr() {
        public int handler() {
          int generator;
          int x, y;
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr bosco_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr bosco_videoram2_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr bosco_colorram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bosco_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bosco_scrollx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bosco_scrolly_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bosco_starcontrol_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr bosco_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          if ((bosco_staronoff.read() & 1) == 0) {
            ...
            for (offs = 0; offs < total_stars; offs++) {
              ...
              if (((stars[offs].set == starset[set][0]) || (stars[offs].set == starset[set][1]))) {
