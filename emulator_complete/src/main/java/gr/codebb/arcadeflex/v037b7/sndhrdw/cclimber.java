...
public class cclimber {
  ...
  public static final int SND_CLOCK = 3072000;
  /* 3.072 Mhz */

  static byte[] samplebuf;
  /* buffer to decode samples at run time */

  static int channel;

  public static ShStartPtr cclimber_sh_start =
      new ShStartPtr() {
  ...
  public static ShStopPtr cclimber_sh_stop =
      new ShStopPtr() {
        public void handler() {
          if (samplebuf != null) {
            samplebuf = null;
  ...
  public static WriteHandlerPtr cclimber_sample_select_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          sample_num = data;
        }
      };
  public static WriteHandlerPtr cclimber_sample_rate_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr cclimber_sample_volume_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr cclimber_sample_trigger_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
