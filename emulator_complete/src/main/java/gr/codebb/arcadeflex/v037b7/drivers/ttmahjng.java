...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.ttmahjng.*;

public class ttmahjng {

  static int psel;
  public static WriteHandlerPtr input_port_matrix_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr input_port_matrix_r =
      new ReadHandlerPtr() {
  ...
  static InputPortPtr input_ports_ttmahjng =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_ttmahjng =
      new MachineDriver(
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_ttmahjng =
      new RomLoadPtr() {
        public void handler() {
  ...
  public static GameDriver driver_ttmahjng =
      new GameDriver(
          "1981",
          "ttmahjng",
          "ttmahjng.java",
          rom_ttmahjng,
          null,
          machine_driver_ttmahjng,
          input_ports_ttmahjng,
          null,
          ROT0,
          "Taito",
          "T.T. Mahjong");
