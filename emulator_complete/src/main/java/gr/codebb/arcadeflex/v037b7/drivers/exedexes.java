...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.exedexes.*;
import static gr.codebb.arcadeflex.vidhrdw.generic.*;

public class exedexes {

  public static InterruptPtr exedexes_interrupt =
      new InterruptPtr() {
        public int handler() {
          if (cpu_getiloops() != 0) {
  ...
  static InputPortPtr input_ports_exedexes =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static SN76496interface sn76496_interface =
      new SN76496interface(
          2, /* 2 chips */ new int[] {3000000, 3000000}, /* 3 MHz????? */ new int[] {36, 36});

  static MachineDriver machine_driver_exedexes =
      new MachineDriver(
  ...
  static RomLoadPtr rom_exedexes =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_savgbees =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1);
          /* 64k for code */
  ...
  public static GameDriver driver_exedexes =
      new GameDriver(
          "1985",
          "exedexes",
          "exedexes.java",
          rom_exedexes,
          null,
          machine_driver_exedexes,
          input_ports_exedexes,
          null,
          ROT270,
          "Capcom",
          "Exed Exes");
  public static GameDriver driver_savgbees =
      new GameDriver(
          "1985",
          "savgbees",
          "exedexes.java",
