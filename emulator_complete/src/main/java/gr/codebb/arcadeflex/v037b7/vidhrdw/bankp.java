...
public class bankp {
  ...
  public static VhConvertColorPromPtr bankp_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr bankp_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr bankp_scroll_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr bankp_vh_stop =
      new VhStopPtr() {
        public void handler() {
          dirtybuffer2 = null;
  ...
  public static WriteHandlerPtr bankp_videoram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bankp_colorram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bankp_out_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr bankp_vh_screenrefresh =
      new VhUpdatePtr() {
          ...
          /* copy the temporary bitmaps to the screen */
          {
            ...
            if (priority == 2) {
              copyscrollbitmap(
                  ...
                  0);
              copybitmap(
                  bitmap, tmpbitmap2, 0, 0, 0, 0, Machine.visible_area, TRANSPARENCY_COLOR, 0);
            } else {
              copybitmap(
                  bitmap, tmpbitmap2, 0, 0, 0, 0, Machine.visible_area, TRANSPARENCY_NONE, 0);
              copyscrollbitmap(
                  bitmap,
                  tmpbitmap,
                  1,
