...
public class bagman {
   ...
   *
   * <p>Bagman has two 32 bytes palette PROMs, connected to the RGB output this way:
   *
   ...
   * <p>*************************************************************************
   */
  public static VhConvertColorPromPtr bagman_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr bagman_flipscreen_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr bagman_vh_screenrefresh =
      new VhUpdatePtr() {
