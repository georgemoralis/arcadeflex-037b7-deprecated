...
public class gunsmoke {
  ...
  static InputPortPtr input_ports_gunsmoke =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static GfxLayout tilelayout =
      new GfxLayout(
          ...
          new int[] {
            ...
            20 * 16, 21 * 16, 22 * 16, 23 * 16, 24 * 16, 25 * 16, 26 * 16, 27 * 16, 28 * 16,
            29 * 16, 30 * 16, 31 * 16
          },
  ...
  static MachineDriver machine_driver_gunsmoke =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 4000000, /* 4 MHz (?) */ readmem, writemem, null, null, interrupt, 1),
            new MachineCPU(
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_gunsmoke =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_gunsmrom =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x20000, REGION_CPU1);
          /* 2*64k for code */
  ...
  static RomLoadPtr rom_gunsmokj =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x20000, REGION_CPU1);
          /* 2*64k for code */
  ...
  static RomLoadPtr rom_gunsmoka =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x20000, REGION_CPU1);
          /* 2*64k for code */
  ...
  switch has no effect.
    */
  public static GameDriver driver_gunsmoke =
      new GameDriver(
          "1985",
          "gunsmoke",
          "gunsmoke.java",
          rom_gunsmoke,
          null,
          machine_driver_gunsmoke,
          input_ports_gunsmoke,
          null,
          ROT270,
          "Capcom",
          "Gun.Smoke (World)");
  public static GameDriver driver_gunsmrom =
      new GameDriver(
          "1985",
          "gunsmrom",
          "gunsmoke.java",
          ...
          "Gun.Smoke (US set 1)");
  public static GameDriver driver_gunsmoka =
      new GameDriver(
          "1986",
          "gunsmoka",
          "gunsmoke.java",
          ...
          "Capcom",
          "Gun.Smoke (US set 2)");
  public static GameDriver driver_gunsmokj =
      new GameDriver(
          "1985",
          "gunsmokj",
          "gunsmoke.java",
