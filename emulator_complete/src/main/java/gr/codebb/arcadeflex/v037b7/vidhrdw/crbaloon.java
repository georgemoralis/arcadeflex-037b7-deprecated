...
public class crbaloon {
   ...
   *
   * <p>Crazy Balloon has no PROMs, the color code directly maps to a color: all bits are inverted
   * bit 3 HALF (intensity) bit 2 BLUE bit 1 GREEN bit 0 RED
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr crbaloon_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr crbaloon_spritectrl_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr crbaloon_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr crbaloon_vh_screenrefresh =
      new VhUpdatePtr() {
