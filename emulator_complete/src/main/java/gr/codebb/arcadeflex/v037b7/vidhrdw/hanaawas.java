...
public class hanaawas {
  ...
  public static VhConvertColorPromPtr hanaawas_vh_convert_color_prom =
      new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(0) / 8; i++) {
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 0)] =
                (char) (color_prom.read(i * 4 + 0x00) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 1)] =
                (char) (color_prom.read(i * 4 + 0x01) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 2)] =
                (char) (color_prom.read(i * 4 + 0x02) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 3)] =
                (char) (color_prom.read(i * 4 + 0x03) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 4)] =
                (char) (color_prom.read(i * 4 + 0x80) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 5)] =
                (char) (color_prom.read(i * 4 + 0x81) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 6)] =
                (char) (color_prom.read(i * 4 + 0x82) & 0x0f);
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i * 8 + 7)] =
                (char) (color_prom.read(i * 4 + 0x83) & 0x0f);
          }
        }
      };

  public static WriteHandlerPtr hanaawas_colorram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr hanaawas_portB_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr hanaawas_vh_screenrefresh =
      new VhUpdatePtr() {
