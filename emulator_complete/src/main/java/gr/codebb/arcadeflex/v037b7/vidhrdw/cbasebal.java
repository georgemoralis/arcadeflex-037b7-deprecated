...
public class cbasebal {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr cbasebal_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static VhStartPtr cbasebal_vh_start =
      new VhStartPtr() {
        public int handler() {
          int i;
          ...
          bg_tilemap =
              tilemap_create(get_bg_tile_info, tilemap_scan_rows, TILEMAP_OPAQUE, 16, 16, 64, 32);
          fg_tilemap =
              tilemap_create(
                  get_fg_tile_info, tilemap_scan_rows, TILEMAP_TRANSPARENT, 8, 8, 64, 32);

          if (cbasebal_textram == null
              || cbasebal_scrollram == null
              || bg_tilemap == null
              || fg_tilemap == null) {
          ...
          for (i = 0; i < Machine.gfx[0].total_colors; i++) {
            memset(
                palette_used_colors,
                Machine.drv.gfxdecodeinfo[0].color_codes_start
                    + i * Machine.gfx[0].color_granularity,
                PALETTE_COLOR_USED,
          ...
          for (i = 0; i < Machine.gfx[1].total_colors; i++) {
            memset(
                palette_used_colors,
                Machine.drv.gfxdecodeinfo[1].color_codes_start
                    + i * Machine.gfx[1].color_granularity,
                PALETTE_COLOR_USED,
          ...
          for (i = 0; i < Machine.gfx[2].total_colors; i++) {
            memset(
                ...
                Machine.drv.gfxdecodeinfo[2].color_codes_start
                    + i * Machine.gfx[2].color_granularity,
   ...
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr cbasebal_textram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr cbasebal_textram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr cbasebal_scrollram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr cbasebal_scrollram_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr cbasebal_gfxctrl_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr cbasebal_scrollx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr cbasebal_scrolly_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static VhUpdatePtr cbasebal_vh_screenrefresh =
      new VhUpdatePtr() {
