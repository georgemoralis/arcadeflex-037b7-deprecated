...
public class airbustr {
  ...
  public static GetTileInfoPtr get_fg_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
          ...
          SET_TILE_INFO(0, airbustr_fgram.read(tile_index) + ((attr & 0x0f) << 8), (attr >> 4) + 0);
        }
      };
  ...
  public static GetTileInfoPtr get_bg_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
          ...
          SET_TILE_INFO(
              0, airbustr_bgram.read(tile_index) + ((attr & 0x0f) << 8), (attr >> 4) + 16);
        }
      };

  public static VhStartPtr airbustr_vh_start =
      new VhStartPtr() {
        public int handler() {
          fg_tilemap =
              tilemap_create(
                  get_fg_tile_info, tilemap_scan_rows, TILEMAP_TRANSPARENT, 16, 16, 32, 32);
          bg_tilemap =
              tilemap_create(get_bg_tile_info, tilemap_scan_rows, TILEMAP_OPAQUE, 16, 16, 32, 32);
  ...
  public static WriteHandlerPtr airbustr_fgram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr airbustr_bgram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr airbustr_scrollregs_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          int xoffs, yoffs;
  ...
  public static VhUpdatePtr airbustr_vh_screenrefresh =
      new VhUpdatePtr() {
