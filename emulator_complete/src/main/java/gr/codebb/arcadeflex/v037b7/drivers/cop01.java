...
public class cop01 {
  ...
  public static WriteHandlerPtr cop01_sound_command_w =
      new WriteHandlerPtr() {
  ...
  /* total guess */
  public static ReadHandlerPtr cop01_sound_command_r =
      new ReadHandlerPtr() {
  ...
  static IOReadPort sound_readport[] = {
    new IOReadPort(0x06, 0x06, cop01_sound_command_r), new IOReadPort(-1) /* end of table */
  };
  ...
  static InputPortPtr input_ports_cop01 =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_cop01 =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 3500000, /* 3.5 MHz (?) */ readmem, writemem, readport, writeport,
                interrupt, 1),
            new MachineCPU(
          ...
          32 * 8,
          32 * 8,
          new rectangle(0, 32 * 8 - 1, 2 * 8, 30 * 8 - 1),
          gfxdecodeinfo,
          256,
          16 * 16 + 4 * 16 + 16 * 16,
  ...
  static RomLoadPtr rom_cop01 =
      new RomLoadPtr() {
        public void handler() {
          ...
          ROM_LOAD(
              "coppromd.19d", 0x0300, 0x0100, 0x6a63dbb8); /* lookup table? (not implemented) */
          ROM_LOAD("copprome.2e", 0x0400, 0x0100, 0x214392fa); /* sprite lookup table */
          ROM_END();
        }
      };

  static RomLoadPtr rom_cop01a =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1);
          /* 64k for code */
  ...
  public static GameDriver driver_cop01 =
      new GameDriver(
          "1985",
          "cop01",
          "cop01.java",
  ...
  public static GameDriver driver_cop01a =
      new GameDriver(
          "1985",
          "cop01a",
          "cop01.java",
