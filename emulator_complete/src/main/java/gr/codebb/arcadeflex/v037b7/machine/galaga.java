...
public class galaga {
  ...
  public static InitMachinePtr galaga_init_machine =
      new InitMachinePtr() {
        public void handler() {
          nmi_timer = null;
  ...
  public static ReadHandlerPtr galaga_sharedram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr galaga_sharedram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr galaga_dsw_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          int bit0, bit1;
  ...
  public static WriteHandlerPtr galaga_customio_data_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr galaga_customio_data_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static ReadHandlerPtr galaga_customio_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static timer_callback galaga_nmi_generate =
      new timer_callback() {
  ...
  public static WriteHandlerPtr galaga_customio_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr galaga_halt_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if ((data & 1) != 0) {
  ...
  public static WriteHandlerPtr galaga_interrupt_enable_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr galaga_interrupt_1 =
      new InterruptPtr() {
        public int handler() {
          galaga_vh_interrupt();
  ...
  public static WriteHandlerPtr galaga_interrupt_enable_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr galaga_interrupt_2 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr galaga_interrupt_enable_3_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr galaga_interrupt_3 =
      new InterruptPtr() {
        public int handler() {
