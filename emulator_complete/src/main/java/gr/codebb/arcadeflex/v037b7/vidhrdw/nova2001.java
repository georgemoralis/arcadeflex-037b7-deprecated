...
public class nova2001 {
  ...
  public static VhConvertColorPromPtr nova2001_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr nova2001_scroll_x_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr nova2001_scroll_y_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr nova2001_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr nova2001_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = 0; offs < spriteram_size[0]; offs += 32) {
            if ((spriteram.read(offs + 0) & 0x40) != 0) {
              ...
              drawgfx(
                  bitmap,
                  Machine.gfx[2 + ((spriteram.read(offs + 0) & 0x80) >> 7)],
