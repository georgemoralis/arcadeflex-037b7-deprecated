...
import static gr.codebb.arcadeflex.sound.MSM5205.*;
import static gr.codebb.arcadeflex.sound.MSM5205H.*;
import static gr.codebb.arcadeflex.sound._3812intf.*;
import static gr.codebb.arcadeflex.sound._3812intfH.*;
...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.magix.*;

public class magix {

  public static InitMachinePtr magix_init_machine =
      new InitMachinePtr() {
        public void handler() {
   ...
   * *************************************************************************
   */
  public static WriteHandlerPtr magix_bankswitch_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr magix_sound_bankswitch_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr magix_adpcm_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          /* Swap the nibbles */
  ...
  static IOReadPort magix_sound_readport[] = {new IOReadPort(-1)};
  static IOWritePort magix_sound_writeport[] = {new IOWritePort(-1)};
   ...
   * <p>*************************************************************************
   */
  static InputPortPtr input_ports_magix =
      new InputPortPtr() {
        public void handler() {
  ...
  static GfxLayout layout_8x8x4_split =
      new GfxLayout(
          8,
          8,
          RGN_FRAC(1, 2),
  ...
  static GfxLayout layout_6x8x8_stretch =
      new GfxLayout(
          8,
          8,
          RGN_FRAC(1, 3),
  ...
  public static vclk_interruptPtr magix_adpcm_int =
      new vclk_interruptPtr() {
  ...
  static YM3812interface magix_ym3812_interface =
      new YM3812interface(1, 4000000, /* ? */ new int[] {50}, new WriteYmHandlerPtr[] {null});

  static MSM5205interface magix_msm5205_interface =
      new MSM5205interface(
          1,
          384000,
  ...
  static MachineDriver machine_driver_magix =
      new MachineDriver(
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, /* Z80B */
            ...
            new MachineCPU(
                ...
                4000000, /* ? */
                magix_sound_readmem,
                magix_sound_writemem,
                magix_sound_readport,
                magix_sound_writeport,
                interrupt,
                1 /* NMI caused by the MSM5205? */)
          },
          60,
          ...
          512,
          256,
          new rectangle(0 + 64, 512 - 64 - 1, 0 + 8, 256 - 8 - 1),
          magix_gfxdecodeinfo,
          0x800,
          0x800,
          null,
          ...
          0,
          new MachineSound[] {
            new MachineSound(SOUND_YM3812, magix_ym3812_interface),
            new MachineSound(SOUND_MSM5205, magix_msm5205_interface)
          });
  ...
  public static GameDriver driver_magix =
      new GameDriver(
          "1995",
          "magix",
          "magix.java",
