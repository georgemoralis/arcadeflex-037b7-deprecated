...
public class gotya {
   ...
   *
   * <p>I'm using Pac Man resistor values
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr gotya_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(0); i++) {
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] =
                (char) ((color_prom.readinc()) & 0x07);
          }
        }
      };

  public static WriteHandlerPtr gotya_video_control_w =
      new WriteHandlerPtr() {
  ...
  public static VhStartPtr gotya_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static VhUpdatePtr gotya_vh_screenrefresh =
      new VhUpdatePtr() {
