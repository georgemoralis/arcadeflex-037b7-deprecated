...
public class arabian {
  ...
  public static VhConvertColorPromPtr arabian_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr arabian_vh_start =
      new VhStartPtr() {
        public int handler() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr arabian_vh_stop =
      new VhStopPtr() {
        public void handler() {
          bitmap_free(tmpbitmap2);
  ...
  public static void blit_byte(
      /*UINT8*/ int u8_x, /*UINT8*/ int u8_y, int val, int val2, /*UINT8*/ int u8_plane) {
    int p1, p2, p3, p4;
  ...
  public static void arabian_blit_area(
      /*UINT8*/ int u8_plane,
      char src, /*UINT8*/
      int u8_x, /*UINT8*/
      int u8_y, /*UINT8*/
    ...
    for (i = 0; i <= u8_sx; i++, u8_x += 4) {
      for (j = 0; j <= u8_sy; j++) {
        blit_byte(
            u8_x,
            u8_y + j,
            memory_region(REGION_GFX1).read(src),
            memory_region(REGION_GFX1).read(src + 0x4000),
            u8_plane);
        src++;
      }
    }
  ...
  public static WriteHandlerPtr arabian_blitter_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr arabian_videoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          ...
          tmpbitmap.line[u8_y + dy].write(
              u8_x + dx, u8_inverse_palette[tmpbitmap.line[u8_y + dy].read(u8_x + dx)]);
          tmpbitmap.line[u8_y + 2 * dy].write(
              u8_x + 2 * dx, u8_inverse_palette[tmpbitmap.line[u8_y + 2 * dy].read(u8_x + 2 * dx)]);
          tmpbitmap.line[u8_y + 3 * dy].write(
              u8_x + 3 * dx, u8_inverse_palette[tmpbitmap.line[u8_y + 3 * dy].read(u8_x + 3 * dx)]);
          tmpbitmap2.line[u8_y].write(u8_x, u8_inverse_palette[tmpbitmap2.line[u8_y].read(u8_x)]);
          tmpbitmap2.line[u8_y + dy].write(
              u8_x + dx, u8_inverse_palette[tmpbitmap2.line[u8_y + dy].read(u8_x + dx)]);
          tmpbitmap2.line[u8_y + 2 * dy].write(
              u8_x + 2 * dx,
              u8_inverse_palette[tmpbitmap2.line[u8_y + 2 * dy].read(u8_x + 2 * dx)]);
          tmpbitmap2.line[u8_y + 3 * dy].write(
              u8_x + 3 * dx,
              u8_inverse_palette[tmpbitmap2.line[u8_y + 3 * dy].read(u8_x + 3 * dx)]);
          ...
          tmpbitmap.line[u8_y + dy].write(
              u8_x + dx, Machine.pens[tmpbitmap.line[u8_y + dy].read(u8_x + dx)]);
          tmpbitmap.line[u8_y + 2 * dy].write(
              u8_x + 2 * dx, Machine.pens[tmpbitmap.line[u8_y + 2 * dy].read(u8_x + 2 * dx)]);
          tmpbitmap.line[u8_y + 3 * dy].write(
              u8_x + 3 * dx, Machine.pens[tmpbitmap.line[u8_y + 3 * dy].read(u8_x + 3 * dx)]);
          tmpbitmap2.line[u8_y].write(u8_x, Machine.pens[tmpbitmap2.line[u8_y].read(u8_x)]);
          tmpbitmap2.line[u8_y + dy].write(
              u8_x + dx, Machine.pens[tmpbitmap2.line[u8_y + dy].read(u8_x + dx)]);
          tmpbitmap2.line[u8_y + 2 * dy].write(
              u8_x + 2 * dx, Machine.pens[tmpbitmap2.line[u8_y + 2 * dy].read(u8_x + 2 * dx)]);
          tmpbitmap2.line[u8_y + 3 * dy].write(
              u8_x + 3 * dx, Machine.pens[tmpbitmap2.line[u8_y + 3 * dy].read(u8_x + 3 * dx)]);
  ...
  public static VhUpdatePtr arabian_vh_screenrefresh =
      new VhUpdatePtr() {
