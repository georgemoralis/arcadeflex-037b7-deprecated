...
import static gr.codebb.arcadeflex.v037b7.mame.commonH.REGION_GFX2;
...
public class munchmo {
  ...
  public static VhConvertColorPromPtr mnchmobl_convert_color_prom =
  ...
  public static WriteHandlerPtr mnchmobl_palette_bank_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr mnchmobl_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if (flipscreen != data) {
            memset(dirtybuffer, 1, 0x100);
  ...
  public static ReadHandlerPtr mnchmobl_sprite_xpos_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return mnchmobl_sprite_xpos.read(offset);
        }
      };
  public static WriteHandlerPtr mnchmobl_sprite_xpos_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr mnchmobl_sprite_attr_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return mnchmobl_sprite_attr.read(offset);
        }
      };
  public static WriteHandlerPtr mnchmobl_sprite_attr_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr mnchmobl_sprite_tile_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return mnchmobl_sprite_tile.read(offset);
        }
      };
  public static WriteHandlerPtr mnchmobl_sprite_tile_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static VhStopPtr mnchmobl_vh_stop =
      new VhStopPtr() {
        public void handler() {
          if (tmpbitmap != null) {
  ...
  public static VhStartPtr mnchmobl_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static ReadHandlerPtr mnchmobl_videoram_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr mnchmobl_videoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          offset = offset & 0xff;
  ...
  public static VhUpdatePtr mnchmobl_vh_screenrefresh =
      new VhUpdatePtr() {
