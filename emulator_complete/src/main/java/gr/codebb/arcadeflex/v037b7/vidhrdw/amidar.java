...
public class amidar {
  ...
  static rectangle spritevisiblearea = new rectangle(2 * 8 + 1, 32 * 8 - 1, 2 * 8, 30 * 8 - 1);
   ...
   *
   * <p>Amidar has one 32 bytes palette PROM, connected to the RGB output this way:
   *
  ...
  public static VhConvertColorPromPtr amidar_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr amidar_attributes_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr amidar_vh_screenrefresh =
      new VhUpdatePtr() {
