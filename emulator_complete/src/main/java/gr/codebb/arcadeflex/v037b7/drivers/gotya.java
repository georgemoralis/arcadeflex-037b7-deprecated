...
public class gotya {
  ...
  static InputPortPtr input_ports_gotya =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static GfxLayout spritelayout =
      new GfxLayout(
          ...
          new int[] {
            39 * 8, 38 * 8, 37 * 8, 36 * 8, 35 * 8, 34 * 8, 33 * 8, 32 * 8, 7 * 8, 6 * 8, 5 * 8,
            4 * 8, 3 * 8, 2 * 8, 1 * 8, 0 * 8
          },
  ...
  static String sample_names[] = { // Address triggered at
    "*gotya",
  ...
  static Samplesinterface samples_interface =
      new Samplesinterface(4, /* 4 channels */ 50, /* volume */ sample_names);

  static MachineDriver machine_driver_gotya =
      new MachineDriver(
          ...
          36 * 8,
          32 * 8,
          new rectangle(0, 36 * 8 - 1, 2 * 8, 30 * 8 - 1),
          gfxdecodeinfo,
          8,
          16 * 4,
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_SAMPLES, samples_interface)});
  ...
  public static GameDriver driver_gotya =
      new GameDriver(
          "1981",
          "gotya",
          "gotya.java",
