...
import static gr.codebb.arcadeflex.v037b7.sndhrdw.wiping.*;
import static gr.codebb.arcadeflex.v037b7.vidhrdw.wiping.*;
...
public class wiping {
  ...
  public static ReadHandlerPtr shared1_r =
      new ReadHandlerPtr() {
  ...
  public static ReadHandlerPtr shared2_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr shared1_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr shared2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr ports_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          int i, res;
  ...
  public static WriteHandlerPtr subcpu_reset_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if ((data & 1) != 0) {
  ...
  static InputPortPtr input_ports_wiping =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* 0 */
  ...
  static InputPortPtr input_ports_rugrats =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* 0 */
  ...
  static GfxLayout spritelayout =
      new GfxLayout(
          ...
          new int[] {
            0 * 16, 1 * 16, 2 * 16, 3 * 16, 4 * 16, 5 * 16, 6 * 16, 7 * 16, 16 * 16, 17 * 16,
  ...
  static CustomSound_interface custom_interface =
      new CustomSound_interface(wiping_sh_start, wiping_sh_stop, null);

  static MachineDriver machine_driver_wiping =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 18432000 / 6, /* 3.072 MHz */ readmem, writemem, null, null, interrupt, 1),
            new MachineCPU(
                ...
                0,
                interrupt,
                140 /* periodic interrupt, don't know about the frequency */),
          },
          60,
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_CUSTOM, custom_interface)});
  ...
  public static GameDriver driver_wiping =
      new GameDriver(
          "1982",
          "wiping",
          "wiping.java",
          rom_wiping,
          null,
          machine_driver_wiping,
          input_ports_wiping,
          null,
          ROT90,
          "Nichibutsu",
          "Wiping");
  public static GameDriver driver_rugrats =
      new GameDriver(
          "1983",
          "rugrats",
          "wiping.java",
