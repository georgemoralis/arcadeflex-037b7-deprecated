...
public class pooyan {
   ...
   *
   * <p>Pooyan has one 32x8 palette PROM and two 256x4 lookup table PROMs (one for characters, one
   * for sprites). The palette PROM is connected to the RGB output this way:
   *
  ...
  public static VhConvertColorPromPtr pooyan_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(0); i++) {
            ...
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] =
                (char) ((color_prom.readinc() & 0x0f) + 0x10);
          }
        }
      };

  public static WriteHandlerPtr pooyan_flipscreen_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr pooyan_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = 0; offs < spriteram_size[0]; offs += 2) {
            ...
            drawgfx(
                ...
                spriteram_2.read(offs) & 0x40,
                ~spriteram_2.read(offs) & 0x80,
                240 - spriteram.read(offs),
                spriteram_2.read(offs + 1),
                Machine.visible_area,
                TRANSPARENCY_COLOR,
                0);
          }
