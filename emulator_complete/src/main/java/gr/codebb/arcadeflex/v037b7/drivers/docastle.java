...
import static gr.codebb.arcadeflex.sound.sn76496.*;
import static gr.codebb.arcadeflex.sound.sn76496H.*;
...
public class docastle {
  ...
  static InputPortPtr input_ports_docastle =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
          ...
          PORT_BITX(
              0x04, 0x04, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Rack Test", KEYCODE_F1, IP_JOY_NONE);
  ...
  static InputPortPtr input_ports_dorunrun =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_dowild =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_jjack =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_kickridr =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static SN76496interface sn76496_interface =
      new SN76496interface(
          4, /* 4 chips */
          new int[] {4000000, 4000000, 4000000, 4000000}, /* 4 MHz? */
          new int[] {25, 25, 25, 25});

  static MachineDriver machine_driver_docastle =
      new MachineDriver(
          ...
          32 * 8,
          32 * 8,
          new rectangle(1 * 8, 31 * 8 - 1, 4 * 8, 28 * 8 - 1),
          gfxdecodeinfo,
          258,
          96 * 16,
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_SN76496, sn76496_interface)});

  static MachineDriver machine_driver_dorunrun =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
   ...
   * *************************************************************************
   */
  static RomLoadPtr rom_docastle =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_docastl2 =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* 64k for code */
  ...
  static RomLoadPtr rom_dorunruc =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* 64k for code */
  ...
  static RomLoadPtr rom_dorunrun =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* 64k for code */
  ...
  static RomLoadPtr rom_dorunru2 =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* 64k for code */
  ...
  static RomLoadPtr rom_kickridr =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1); /* 64k for code */
  ...
  public static GameDriver driver_docastle =
      new GameDriver(
          "1983",
          "docastle",
          "docastle.java",
  ...
  public static GameDriver driver_docastl2 =
      new GameDriver(
          "1983",
          "docastl2",
          "docastle.java",
  ...
  public static GameDriver driver_douni =
      new GameDriver(
          "1983",
          "douni",
          "docastle.java",
          ...
          "Universal",
          "Mr. Do vs. Unicorns");
  public static GameDriver driver_dorunrun =
      new GameDriver(
          "1984",
          "dorunrun",
          "docastle.java",
          ...
          "Universal",
          "Do! Run Run (set 1)");
  public static GameDriver driver_dorunru2 =
      new GameDriver(
          "1984",
          "dorunru2",
          "docastle.java",
          ...
          "Universal",
          "Do! Run Run (set 2)");
  public static GameDriver driver_dorunruc =
      new GameDriver(
          "1984",
          "dorunruc",
          "docastle.java",
  ...
  public static GameDriver driver_spiero =
      new GameDriver(
          "1987",
          "spiero",
          "docastle.java",
          ...
          "Universal",
          "Super Pierrot (Japan)");
  public static GameDriver driver_dowild =
      new GameDriver(
          "1984",
          "dowild",
          "docastle.java",
          ...
          "Universal",
          "Mr. Do's Wild Ride");
  public static GameDriver driver_jjack =
      new GameDriver(
          "1984",
          "jjack",
          "docastle.java",
          ...
          "Universal",
          "Jumping Jack");
  public static GameDriver driver_kickridr =
      new GameDriver(
          "1984",
          "kickridr",
          "docastle.java",
