...
public class nova2001 {
  ...
  static InputPortPtr input_ports_nova2001 =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
  ...
  static MachineDriver machine_driver_nova2001 =
      new MachineDriver(
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 3000000, /* 3 MHz */ readmem, writemem, null, null, interrupt, 1)
          },
          60,
  ...
  static RomLoadPtr rom_nova2001 =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_nov2001u =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1);
  ...
  public static GameDriver driver_nova2001 =
      new GameDriver(
          "1983",
          "nova2001",
          "nova2001.java",
          rom_nova2001,
          null,
          machine_driver_nova2001,
          input_ports_nova2001,
          null,
          ROT0,
          "UPL",
          "Nova 2001 (Japan)");
  public static GameDriver driver_nov2001u =
      new GameDriver(
          "1983",
          "nov2001u",
          "nova2001.java",
