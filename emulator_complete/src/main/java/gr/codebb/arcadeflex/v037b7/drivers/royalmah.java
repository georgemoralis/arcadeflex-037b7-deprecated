...
public class royalmah {
  ...
  public static VhConvertColorPromPtr royalmah_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr royalmah_videoram_w =
      new WriteHandlerPtr() {
  ...
  public static VhUpdatePtr royalmah_vh_screenrefresh =
      new VhUpdatePtr() {
  ...
  public static WriteHandlerPtr royalmah_rom_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr royalmah_input_port_select_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr royalmah_player_1_port_r =
      new ReadHandlerPtr() {
  ...
  public static ReadHandlerPtr royalmah_player_2_port_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  static InputPortPtr input_ports_royalmah =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* P1 IN0 */
  ...
  static MachineDriver machine_driver_royalmah =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 3000000, /* 3.00 MHz ? */ readmem, writemem, readport, writeport,
                interrupt, 1)
          },
          60,
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_royalmah =
      new RomLoadPtr() {
        public void handler() {
  ...
  public static GameDriver driver_royalmah =
      new GameDriver(
          "1982",
          "royalmah",
          "royalmah.java",
          rom_royalmah,
          null,
          machine_driver_royalmah,
          input_ports_royalmah,
          null,
          ROT180,
          "Falcon",
          "Royal Mahjong");
