...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.kangaroo.*;

public class kangaroo {

  public static InitMachinePtr kangaroo_init_machine =
      new InitMachinePtr() {
        public void handler() {
   ...
   */
  public static ReadHandlerPtr kangaroo_sec_chip_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr kangaroo_sec_chip_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr kangaroo_coin_counter_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  static InputPortPtr input_ports_fnkyfish =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_kangaroo =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_kangaroo =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 10000000 / 4, /* 2.5 MHz */ readmem, writemem, null, null, interrupt, 1),
            new MachineCPU(
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_fnkyfish =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_kangaroo =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x14000, REGION_CPU1); /* 64k for code + 16k for banked ROMs */
  ...
  static RomLoadPtr rom_kangaroa =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x14000, REGION_CPU1); /* 64k for code + 16k for banked ROMs */
          ROM_LOAD("tvg_75.0", 0x0000, 0x1000, 0x0d18c581);
  ...
  static RomLoadPtr rom_kangarob =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x14000, REGION_CPU1); /* 64k for code + 16k for banked ROMs */
          ROM_LOAD("tvg_75.0", 0x0000, 0x1000, 0x0d18c581);
  ...
  public static GameDriver driver_fnkyfish =
      new GameDriver(
          "1981",
          "fnkyfish",
          "kangaroo.java",
          rom_fnkyfish,
          null,
          machine_driver_kangaroo,
          input_ports_fnkyfish,
          null,
          ROT90,
          "Sun Electronics",
          "Funky Fish");
  public static GameDriver driver_kangaroo =
      new GameDriver(
          "1982",
          "kangaroo",
          "kangaroo.java",
          ...
          "Sun Electronics",
          "Kangaroo");
  public static GameDriver driver_kangaroa =
      new GameDriver(
          "1982",
          "kangaroa",
          "kangaroo.java",
          ...
          "Kangaroo (Atari)");
  public static GameDriver driver_kangarob =
      new GameDriver(
          "1982",
          "kangarob",
          "kangaroo.java",
