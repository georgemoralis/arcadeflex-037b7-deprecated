...
public class goindol {
  ...
  public static WriteHandlerPtr goindol_bankswitch_w =
      new WriteHandlerPtr() {
  ...
  static InputPortPtr input_ports_goindol =
      new InputPortPtr() {
        public void handler() {
  ...
  static InputPortPtr input_ports_homo =
      new InputPortPtr() {
        public void handler() {
  ...
  static MachineDriver machine_driver_goindol =
      new MachineDriver(
  ...
  public static InitDriverPtr init_goindol =
      new InitDriverPtr() {
        public void handler() {
  ...
  public static InitDriverPtr init_homo =
      new InitDriverPtr() {
        public void handler() {
          UBytePtr rom = memory_region(REGION_CPU1);
  ...
  public static GameDriver driver_goindol =
      new GameDriver(
          "1987",
          "goindol",
          "goindol.java",
          rom_goindol,
          null,
          machine_driver_goindol,
          input_ports_goindol,
          init_goindol,
          ROT90,
          "Sun a Electronics",
          "Goindol");
  public static GameDriver driver_homo =
      new GameDriver(
          "1987",
          "homo",
          "goindol.java",
