...
public class polyplay {
  ...
  public static ShStartPtr polyplay_sh_start =
      new ShStartPtr() {
  ...
  public static ShStopPtr polyplay_sh_stop =
      new ShStopPtr() {
        public void handler() {
  ...
  public static ShUpdatePtr polyplay_sh_update =
      new ShUpdatePtr() {
        public void handler() {
  ...
  public static void play_channel1(int data) {
    if (data != 0) {
      ...
      mixer_play_sample_16(
          channellfo + 0,
          new ShortPtr(backgroundwave),
          sizeof(backgroundwave) * 2,
          sizeof(backgroundwave) * freq1,
          1);
    } else {
