...
public class mermaid {
   ...
   *
   * <p>I'm not sure about the resistor value, I'm using the Galaxian ones.
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr mermaid_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr mermaid_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = 0; offs < videoram_size[0]; offs++) {
            ...
            code =
                mermaid_foreground_videoram.read(offs)
                    | ((mermaid_foreground_colorram.read(offs) & 0x30) << 4);
