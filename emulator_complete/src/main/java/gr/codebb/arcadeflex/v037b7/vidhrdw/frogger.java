...
public class frogger {
   ...
   *
   * <p>Frogger has one 32 bytes palette PROM, connected to the RGB output this way:
   *
   ...
   *
   * <p>Additionally, there is a bit which is 1 in the upper half of the display (136 lines? I'm not
   * sure of the exact value); it is connected to blue through a 470 ohm resistor. It is used to
   * make the river blue instead of black.
   *
   * <p>*************************************************************************
   */
  public static VhConvertColorPromPtr frogger_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr frogger_attributes_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr frogger_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr frogger_vh_screenrefresh =
      new VhUpdatePtr() {
            ...
            if (spriteram.read(offs + 3) != 0) {
              ...
              if (flipscreen != 0) {
                ...
                drawgfx(
                    ...
                    col,
                    NOT(spriteram.read(offs + 1) & 0x40),
                    NOT(spriteram.read(offs + 1) & 0x80),
                    x,
                    30 * 8 - y,
  ...
  public static VhUpdatePtr frogger2_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          int i, offs;
