...
import static gr.codebb.arcadeflex.sound.okim6295.*;
import static gr.codebb.arcadeflex.sound.okim6295H.*;
...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.airbustr.*;
...
public class airbustr {
  ...
  public static InitMachinePtr airbustr_init_machine =
      new InitMachinePtr() {
        public void handler() {
  ...
  public static InterruptPtr airbustr_interrupt =
      new InterruptPtr() {
        public int handler() {
  ...
  public static ReadHandlerPtr sharedram_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return sharedram.read(offset);
        }
      };
  public static WriteHandlerPtr sharedram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr devram_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          switch (offset) {
            ...
            case 0xff3:
              {
                int x =
                    (devram.read(0xff0) + devram.read(0xff1) * 256)
  ...
  public static WriteHandlerPtr devram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr bankswitch_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  /* Ports */
  public static WriteHandlerPtr cause_nmi_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  static IOReadPort readport[] = {new IOReadPort(-1)};
  ...
  public static InterruptPtr airbustr_interrupt2 =
      new InterruptPtr() {
        public int handler() {
          addr2 ^= 0x02;
  ...
  public static WriteHandlerPtr bankswitch2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr airbustr_paletteram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          int r, g, b;
          ...
          palette_change_color(offset / 2, (r * 0xff) / 0x1f, (g * 0xff) / 0x1f, (b * 0xff) / 0x1f);
        }
      };
  ...
  (called during int fd)
      ...
      */
  public static ReadHandlerPtr soundcommand_status_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static ReadHandlerPtr soundcommand2_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr soundcommand_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr port_38_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          u4 = data;
        }
   ...
   **
   */
  public static WriteHandlerPtr sound_bankswitch_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  /* Ports */
  public static ReadHandlerPtr soundcommand_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr soundcommand2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  [2] Service
  [3] Dsw 1			[4] Dsw 2	*/
  static InputPortPtr input_ports_airbustr =
      new InputPortPtr() {
        public void handler() {
          ...
          PORT_DIPNAME(
              0x02, 0x02, DEF_STR("Flip_Screen")); // if active, bit 4 of cpu2 bank is on ..
  ...
  static OKIM6295interface okim6295_interface =
      new OKIM6295interface(
          1, new int[] {18000}, /* ?? */ new int[] {REGION_SOUND1}, new int[] {50});

  static MachineDriver machine_driver_airbustr =
      new MachineDriver(
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80,
            ...
            new MachineCPU(
                ...
                sound_writeport,
                interrupt,
                1 /* nmi are caused by sub cpu writing a sound command */),
          },
          60,
          ...
          256,
          256,
          new rectangle(0, 256 - 1, 0 + 16, 256 - 16 - 1),
          gfxdecodeinfo,
          256 * 3,
          256 * 3,
          null,
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_airbustr =
      new RomLoadPtr() {
        public void handler() {
  ...
  public static InitDriverPtr init_airbustr =
      new InitDriverPtr() {
        public void handler() {
          int i;
          UBytePtr RAM;
  ...
  public static GameDriver driver_airbustr =
      new GameDriver(
          "1990",
          "airbustr",
          "airbustr.java",
