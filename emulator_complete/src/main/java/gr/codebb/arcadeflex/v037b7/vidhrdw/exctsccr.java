...
public class exctsccr {
  ...
  public static WriteHandlerPtr exctsccr_gfx_bank_w =
      new WriteHandlerPtr() {
  ...
  public static timer_callback exctsccr_fm_callback =
      new timer_callback() {
  ...
  public static VhStartPtr exctsccr_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static VhStopPtr exctsccr_vh_stop =
      new VhStopPtr() {
        public void handler() {
   ...
   * <p>*************************************************************************
   */
  public static VhConvertColorPromPtr exctsccr_vh_convert_color_prom =
      new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          idx = 0;
          for (i = 0; i < 32; i++) {
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 0 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 1 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 2 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 3 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 0 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 1 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 2 + (i * 4)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 3 + (i * 4)));
          }
          ...
          for (i = 0; i < 15 * 16; i++) {
            if ((i % 16) < 8) {
              colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx] =
                  (char) (color_prom.read(i) + 16);
              idx++;
            }
          }
          ...
          for (i = 16; i < 32; i++) {
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 0 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 1 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 2 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 3 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 0 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 1 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 2 + (i * 4)) + 16);
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + idx++] =
                (char) (color_prom.read(256 + 128 + 3 + (i * 4)) + 16);
          }
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr exctsccr_vh_screenrefresh =
      new VhUpdatePtr() {
