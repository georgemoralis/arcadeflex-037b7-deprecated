...
public class pengo {
  ...
  public static VhConvertColorPromPtr pacman_vh_convert_color_prom =
  ...
  public static VhConvertColorPromPtr pengo_vh_convert_color_prom =
      new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          int i;
          int p_inc = 0;
          ...
          for (i = 0; i < TOTAL_COLORS(2); i++) {
            if (color_prom.read() != 0) {
              colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] =
                  (char) ((color_prom.read() & 0x0f) + 0x10); /* second palette bank */
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr pengo_vh_start =
      new VhStartPtr() {
        public int handler() {
          gfx_bank = 0;
          xoffsethack = 0;
  ...
  public static VhStartPtr pacman_vh_start =
      new VhStartPtr() {
        public int handler() {
          gfx_bank = 0;
  ...
  public static WriteHandlerPtr pengo_gfxbank_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr pengo_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr pengo_vh_screenrefresh =
      new VhUpdatePtr() {
