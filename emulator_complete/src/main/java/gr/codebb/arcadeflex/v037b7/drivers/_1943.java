...
public class _1943 {
  ...
  public static ReadHandlerPtr c1943_protection_r =
      new ReadHandlerPtr() {
  ...
  static InputPortPtr input_ports_1943 =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_1943 =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
                CPU_Z80, 6000000, /* 6 Mhz */ readmem, writemem, null, null, interrupt, 1),
            new MachineCPU(
      ...
      new RomLoadPtr() {
        public void handler() {
          ...
          ROM_LOAD(
              ...
              0x0a00,
              0x0100,
              0x91a8a2e1); /* priority encoder / palette selector (not used) */
          ROM_LOAD("bmprom.06", 0x0b00, 0x0100, 0x0eaf5158); /* video timing (not used) */
          ROM_END();
        }
      };

  static RomLoadPtr rom_1943j =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x30000, REGION_CPU1); /* 64k for code + 128k for the banked ROMs images */
  ...
  public static GameDriver driver_1943 =
      new GameDriver(
          "1987",
          "1943",
          "_1943.java",
          ...
          GAME_NO_COCKTAIL);
  public static GameDriver driver_1943j =
      new GameDriver(
          "1987",
          "1943j",
          "_1943.java",
          ...
          GAME_NO_COCKTAIL);
  public static GameDriver driver_1943kai =
      new GameDriver(
          "1987",
          "1943kai",
          "_1943.java",
