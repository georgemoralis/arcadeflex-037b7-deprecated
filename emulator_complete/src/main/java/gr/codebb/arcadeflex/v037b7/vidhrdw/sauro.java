...
import static gr.codebb.arcadeflex.drivers.speedbal.*;
...
public class sauro {
   ...
   *
   ***************************************************************************/
  public static VhConvertColorPromPtr sauro_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr sauro_scroll1_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr sauro_scroll2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   *
   ***************************************************************************/
  public static VhUpdatePtr sauro_vh_screenrefresh =
      new VhUpdatePtr() {
