...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.sauro.*;
...
public class sauro {
  ...
  public static WriteHandlerPtr sauro_sound_command_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr sauro_sound_command_r =
      new ReadHandlerPtr() {
  ...
  static InputPortPtr input_ports_sauro =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static GfxLayout spritelayout =
      new GfxLayout(
          ...
          new int[] {0, 1, 2, 3}, /* The 4 planes are packed together */
          new int[] {
            1 * 4, 0 * 4, 3 * 4, 2 * 4, 5 * 4, 4 * 4, 7 * 4, 6 * 4, 9 * 4, 8 * 4, 11 * 4, 10 * 4,
            13 * 4, 12 * 4, 15 * 4, 14 * 4
          },
          new int[] {
            3 * 0x8000 * 8 + 0 * 4 * 16,
  ...
  public static InterruptPtr sauron_interrupt =
      new InterruptPtr() {
        public int handler() {
  ...
  static YM3526interface ym3812_interface =
      new YM3526interface(
          1, /* 1 chip (no more supported) */
          3600000, /* 3.600000 MHz ? */
          new int[] {255} /* (not supported) */);

  static MachineDriver machine_driver_sauro =
      new MachineDriver(
          ...
          60,
          5000, /* frames per second, vblank duration (otherwise sprites lag) */
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_YM3812, ym3812_interface)});
  ...
  public static InitDriverPtr init_sauro =
      new InitDriverPtr() {
        public void handler() {
  ...
  public static GameDriver driver_sauro =
      new GameDriver(
          "1987",
          "sauro",
          "sauro.java",
