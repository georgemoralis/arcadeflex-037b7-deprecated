...
public class pbaction {
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr pbaction_vh_start =
      new VhStartPtr() {
        public int handler() {
          int i;
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr pbaction_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr pbaction_videoram2_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr pbaction_colorram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr pbaction_scroll_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          scroll = -(data - 3);
        }
  ...
  public static WriteHandlerPtr pbaction_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr pbaction_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = spriteram_size[0] - 4; offs >= 0; offs -= 4) {
            ...
            drawgfx(
                bitmap,
                Machine.gfx[(spriteram.read(offs) & 0x80) != 0 ? 3 : 2], /* normal or double size */
                spriteram.read(offs),
