...
public class ttmahjng {
  ...
  public static VhConvertColorPromPtr ttmahjng_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr ttmahjng_vh_start =
      new VhStartPtr() {
        public int handler() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr ttmahjng_vh_stop =
      new VhStopPtr() {
        public void handler() {
          bitmap_free(tmpbitmap1);
  ...
  public static WriteHandlerPtr ttmahjng_out0_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr ttmahjng_out1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * *************************************************************************
   */
  public static ReadHandlerPtr ttmahjng_sharedram_r =
      new ReadHandlerPtr() {
   ...
   * *************************************************************************
   */
  public static WriteHandlerPtr ttmahjng_sharedram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * *************************************************************************
   */
  public static ReadHandlerPtr ttmahjng_videoram1_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
   ...
   * *************************************************************************
   */
  public static ReadHandlerPtr ttmahjng_videoram2_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return ttmahjng_videoram1.read(offset);
        }
   ...
   * *************************************************************************
   */
  public static WriteHandlerPtr ttmahjng_videoram1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * *************************************************************************
   */
  public static WriteHandlerPtr ttmahjng_videoram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr ttmahjng_vh_screenrefresh =
      new VhUpdatePtr() {
