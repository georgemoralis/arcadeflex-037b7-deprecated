...
public class funkybee {
  ...
  public static VhConvertColorPromPtr funkybee_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr funkybee_gfx_bank_w =
      new WriteHandlerPtr() {
  ...
  static void draw_chars(osd_bitmap _tmpbitmap, osd_bitmap bitmap) {
    ...
    /* copy the temporary bitmap to the screen */
    {
      ...
      copyscrollbitmap(
          bitmap, _tmpbitmap, 32, scroll, 0, null, Machine.visible_area, TRANSPARENCY_NONE, 0);
    }
  }

  public static VhUpdatePtr funkybee_vh_screenrefresh =
      new VhUpdatePtr() {
