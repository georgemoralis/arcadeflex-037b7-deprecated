...
import static gr.codebb.arcadeflex.sound.sn76477.*;
import static gr.codebb.arcadeflex.sound.sn76477H.*;
...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.crbaloon.*;
...
public class crbaloon {
  ...
  public static InitMachinePtr crbaloon_machine_init =
      new InitMachinePtr() {
        public void handler() {
          /* MIXER A = 0, MIXER C = 1 */
  ...
  public static WriteHandlerPtr crbaloon_06_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr crbaloon_08_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          val08 = data;
  ...
  public static WriteHandlerPtr crbaloon_0a_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          val0a = data;
        }
  ...
  public static ReadHandlerPtr crbaloon_IN2_r =
      new ReadHandlerPtr() {
  ...
  public static ReadHandlerPtr crbaloon_IN3_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static ReadHandlerPtr crbaloon_IN_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          switch (offset & 0x03) {
            case 0:
  ...
  static IOReadPort readport[] = {
    new IOReadPort(0x00, 0x0f, crbaloon_IN_r), new IOReadPort(-1) /* end of table */
  };
  ...
  static InputPortPtr input_ports_crbaloon =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
  ...
  static GfxLayout spritelayout =
      new GfxLayout(
          ...
          new int[] {
            31 * 8, 30 * 8, 29 * 8, 28 * 8, 27 * 8, 26 * 8, 25 * 8, 24 * 8, 23 * 8, 22 * 8, 21 * 8,
            20 * 8, 19 * 8, 18 * 8, 17 * 8, 16 * 8, 15 * 8, 14 * 8, 13 * 8, 12 * 8, 11 * 8, 10 * 8,
  ...
  static SN76477interface sn76477_interface =
      new SN76477interface(
          1, /* 1 chip */
  ...
  static MachineDriver machine_driver_crbaloon =
      new MachineDriver(
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_SN76477, sn76477_interface)});
   ...
   * <p>*************************************************************************
   */
  static RomLoadPtr rom_crbaloon =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_crbalon2 =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1);
          /* 64k for code */
  ...
  public static GameDriver driver_crbaloon =
      new GameDriver(
          "1980",
          "crbaloon",
          "crbaloon.java",
  ...
  public static GameDriver driver_crbalon2 =
      new GameDriver(
          "1980",
          "crbalon2",
          "crbaloon.java",
