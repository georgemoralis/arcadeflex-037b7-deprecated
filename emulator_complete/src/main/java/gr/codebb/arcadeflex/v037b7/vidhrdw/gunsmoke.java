...
public class gunsmoke {
   ...
   *
   * <p>Gunsmoke has three 256x4 palette PROMs (one per gun) and a lot ;-) of 256x4 lookup table
   * PROMs. The palette PROMs are connected to the RGB output this way:
   *
  ...
  public static VhConvertColorPromPtr gunsmoke_vh_convert_color_prom =
  ...
  public static VhStartPtr gunsmoke_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static VhStopPtr gunsmoke_vh_stop =
      new VhStopPtr() {
        public void handler() {
          bitmap_free(bgbitmap);
        }
  ...
  public static WriteHandlerPtr gunsmoke_c804_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr gunsmoke_d806_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr gunsmoke_vh_screenrefresh =
      new VhUpdatePtr() {
