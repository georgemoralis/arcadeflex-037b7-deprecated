...
import static gr.codebb.arcadeflex.v037b7.mame.commonH.REGION_GFX4;
...
public class xevious {
  ...
  static int /*unsigned char*/
      namco_key[] = /*  LDRU,LDR,LDU,LD ,LRU,LR ,LU , L ,DRU,DR ,DU , D ,RU , R , U ,NON  */ {
    5, 5, 5, 5, 7, 6, 7, 6, 3, 3, 4, 4, 1, 2, 0, 8
  };

  public static InitMachinePtr xevious_init_machine =
      new InitMachinePtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr xevious_bs_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr xevious_bb_r =
      new ReadHandlerPtr() {
  ...
  public static ReadHandlerPtr xevious_sharedram_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static WriteHandlerPtr xevious_sharedram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr xevious_dsw_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          int bit0, bit1;
  ...
  public static WriteHandlerPtr xevious_customio_data_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          ...
          switch (customio_command) {
            ...
            case 0x68:
              if (offset == 6) {
                ...
                /* We just use samples. */
                if (memcmp(customio, new char[] {0x40, 0x40, 0x40, 0x01, 0xff, 0x00, 0x20}, 7)
                    == 0) {
                  sample_start(0, 0, 0);
                } else if (memcmp(
                        customio, new char[] {0x30, 0x40, 0x00, 0x02, 0xdf, 0x00, 0x10}, 7)
                    == 0) {
                  sample_start(0, 1, 0);
                }
              }
  ...
  public static ReadHandlerPtr xevious_customio_data_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static ReadHandlerPtr xevious_customio_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static timer_callback xevious_nmi_generate =
      new timer_callback() {
  ...
  public static WriteHandlerPtr xevious_customio_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr xevious_halt_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if ((data & 1) != 0) {
  ...
  public static WriteHandlerPtr xevious_interrupt_enable_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr xevious_interrupt_1 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr xevious_interrupt_enable_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr xevious_interrupt_2 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr xevious_interrupt_enable_3_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr xevious_interrupt_3 =
      new InterruptPtr() {
        public int handler() {
