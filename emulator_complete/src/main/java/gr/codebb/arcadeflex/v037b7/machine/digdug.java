...
public class digdug {
  ...
  public static InitMachinePtr digdig_init_machine =
      new InitMachinePtr() {
        public void handler() {
          credits = 0;
          nmi_timer = null;
  ...
  public static ReadHandlerPtr digdug_sharedram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr digdug_sharedram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr digdug_customio_data_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr digdug_customio_data_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          switch (customio_command) {
            case 0x71:
  ...
  public static ReadHandlerPtr digdug_customio_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return customio_command;
        }
      };
  public static timer_callback digdug_nmi_generate =
      new timer_callback() {
  ...
  public static WriteHandlerPtr digdug_customio_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr digdug_halt_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if ((data & 1) != 0) {
  ...
  public static WriteHandlerPtr digdug_interrupt_enable_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr digdug_interrupt_1 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr digdug_interrupt_enable_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr digdug_interrupt_2 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr digdug_interrupt_enable_3_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr digdug_interrupt_3 =
      new InterruptPtr() {
        public int handler() {
