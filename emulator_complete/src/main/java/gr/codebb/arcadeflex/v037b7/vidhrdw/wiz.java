...
public class wiz {
   ...
   *
   * <p>Stinger has three 256x4 palette PROMs (one per gun). The palette PROMs are connected to the
   * RGB output this way:
   *
   * <p>bit 3 -- 100 ohm resistor -- RED/GREEN/BLUE -- 220 ohm resistor -- RED/GREEN/BLUE -- 470 ohm
   * resistor -- RED/GREEN/BLUE bit 0 -- 1 kohm resistor -- RED/GREEN/BLUE
   *
   * <p>*************************************************************************
   */
  public static VhConvertColorPromPtr wiz_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr wiz_attributes_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr wiz_palettebank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr wiz_char_bank_select_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr wiz_flipx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if (flipx != data) {
            flipx = data;
  ...
  public static WriteHandlerPtr wiz_flipy_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if (flipy != data) {
            flipy = data;
  ...
  static void draw_sprites(
      osd_bitmap bitmap, UBytePtr sprite_ram, int bank, rectangle visible_area) {
    int offs;
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr wiz_vh_screenrefresh =
      new VhUpdatePtr() {
  ...
  public static VhUpdatePtr stinger_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
