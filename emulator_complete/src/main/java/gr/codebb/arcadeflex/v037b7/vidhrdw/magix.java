...
public class magix {
   ...
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr magix_videobank_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr magix_videoram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr magix_videoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr magix_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>Offset:
   *
   * <p>Videoram + 0000.w Code Colorram + 0000.b Color
   *
   * <p>*************************************************************************
   */
  /* Background */
  ...
  public static GetTileInfoPtr get_tile_info_0 =
      new GetTileInfoPtr() {
        @Override
        public void handler(int tile_index) {
          int code =
              magix_videoram_0.read(0x1000 + tile_index * 2 + 0)
                  + magix_videoram_0.read(0x1000 + tile_index * 2 + 1) * 256;
  ...
  public static GetTileInfoPtr get_tile_info_1 =
      new GetTileInfoPtr() {
        @Override
        public void handler(int tile_index) {
          int code =
              magix_videoram_1.read(0x1000 + tile_index * 2 + 0)
                  + magix_videoram_1.read(0x1000 + tile_index * 2 + 1) * 256;
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr magix_vh_start =
      new VhStartPtr() {
        public int handler() {
          tilemap_0 =
              tilemap_create(
                  get_tile_info_0, tilemap_scan_rows, TILEMAP_OPAQUE, 8, 8, DIM_NX_0, DIM_NY_0);
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr magix_vh_screenrefresh =
      new VhUpdatePtr() {
