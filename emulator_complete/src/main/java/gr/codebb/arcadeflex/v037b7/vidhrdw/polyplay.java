...
import static gr.codebb.arcadeflex.old2.mame.drawgfx.decodechar;
...
public class polyplay {
  ...
  public static VhConvertColorPromPtr polyplay_init_palette =
  ...
  public static WriteHandlerPtr polyplay_characterram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr polyplay_characterram_r =
      new ReadHandlerPtr() {
  ...
  public static VhUpdatePtr polyplay_vh_screenrefresh =
      new VhUpdatePtr() {
