...
public class galivan {
  ...
  public static InitMachinePtr galivan_init_machine =
      new InitMachinePtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr galivan_sound_command_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr galivan_sound_command_r =
      new ReadHandlerPtr() {
  ...
  public static ReadHandlerPtr IO_port_c0_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          return (0x58);
  ...
  public static WriteHandlerPtr ninjemak_videoreg_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          switch (offset) {
            case 0x0b:
  ...
  static IOReadPort sound_readport[] = {
    ...
    new IOReadPort(0x06, 0x06, galivan_sound_command_r), new IOReadPort(-1) /* end of table */
  };
  ...
  static InputPortPtr input_ports_galivan =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_dangar =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  /* the last two dip switches are different in each version */
  static InputPortPtr input_ports_dangar2 =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  /* the last two dip switches are different in each version */
  static InputPortPtr input_ports_dangarb =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_ninjemak =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static InputPortPtr input_ports_youma =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static GfxLayout charlayout_512 =
      new GfxLayout(
          8,
          8, /* 8*8 characters */
          512, /* NUM characters */
  ...
  static GfxLayout charlayout_1024 =
      new GfxLayout(
          8,
          8, /* 8*8 characters */
          1024, /* NUM characters */
  ...
  static GfxLayout tilelayout =
      new GfxLayout(
          ...
          new int[] {
            0 * 64, 1 * 64, 2 * 64, 3 * 64, 4 * 64, 5 * 64, 6 * 64, 7 * 64, 8 * 64, 9 * 64, 10 * 64,
            11 * 64, 12 * 64, 13 * 64, 14 * 64, 15 * 64
          },
          16 * 16 * 4);

  static GfxLayout spritelayout_512 =
      new GfxLayout(
          16,
          16, /* 16*16 sprites */
          512, /* NUM sprites */
  ...
  static GfxLayout spritelayout_1024 =
      new GfxLayout(
          16,
          16, /* 16*16 sprites */
          1024, /* NUM sprites */
  ...
  static YM3526interface YM3526_interface =
      new YM3526interface(1, 8000000 / 2, /* 4 MHz? */ new int[] {60});

  static DACinterface dac_interface = new DACinterface(2, new int[] {60, 60});

  static MachineDriver machine_driver_galivan =
      new MachineDriver(
          ...
          0,
          new MachineSound[] {
            new MachineSound(SOUND_YM3526, YM3526_interface),
            new MachineSound(SOUND_DAC, dac_interface)
          });

  static MachineDriver machine_driver_ninjemak =
      new MachineDriver(
          /* basic machine hardware */
          new MachineCPU[] {
            new MachineCPU(
          ...
          32 * 8,
          32 * 8,
          new rectangle(1 * 8, 31 * 8 - 1, 2 * 8, 30 * 8 - 1),
  ...
  static RomLoadPtr rom_galivan2 =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_ninjemak =
      new RomLoadPtr() {
        public void handler() {
  ...
  public static GameDriver driver_galivan =
      new GameDriver(
          "1985",
          "galivan",
          "galivan.java",
  ...
  public static GameDriver driver_galivan2 =
      new GameDriver(
          "1985",
          "galivan2",
          "galivan.java",
  ...
  public static GameDriver driver_dangar =
      new GameDriver(
          "1986",
          "dangar",
          "galivan.java",
  ...
  public static GameDriver driver_dangar2 =
      new GameDriver(
          "1986",
          "dangar2",
          "galivan.java",
  ...
  public static GameDriver driver_dangarb =
      new GameDriver(
          "1986",
          "dangarb",
          "galivan.java",
  ...
  public static GameDriver driver_ninjemak =
      new GameDriver(
          "1986",
          "ninjemak",
          "galivan.java",
          ...
          "Nichibutsu",
          "Ninja Emaki (US)");
  public static GameDriver driver_youma =
      new GameDriver(
          "1986",
          "youma",
          "galivan.java",
