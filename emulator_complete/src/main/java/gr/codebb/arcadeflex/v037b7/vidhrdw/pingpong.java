...
public class pingpong {
   ...
   *
   * <p>Ping Pong has a 32 bytes palette PROM and two 256 bytes color lookup table PROMs (one for
   * sprites, one for characters). I don't know for sure how the palette PROM is connected to the
   * RGB output, but it's probably the usual:
   *
  ...
  public static VhConvertColorPromPtr pingpong_vh_convert_color_prom =
   ...
   * *************************************************************************
   *
   * <p>Draw the game screen in the given osd_bitmap.
   *
   * <p>*************************************************************************
   */
  public static VhUpdatePtr pingpong_vh_screenrefresh =
      new VhUpdatePtr() {
