...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.gundealr.*;
...
public class gundealr {
  ...
  public static InterruptPtr yamyam_interrupt =
      new InterruptPtr() {
        public int handler() {
          if (cpu_getiloops() == 0) {
  ...
  public static WriteHandlerPtr yamyam_bankswitch_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr yamyam_protection_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          UBytePtr RAM = memory_region(REGION_CPU1);
  ...
  static IOReadPort readport[] = {
    new IOReadPort(0x01, 0x01, YM2203_read_port_0_r), new IOReadPort(-1) /* end of table */
  };
  ...
  static InputPortPtr input_ports_gundealr =
      new InputPortPtr() {
        public void handler() {
          PORT_START(); /* DSW0 */
  ...
  static InputPortPtr input_ports_yamyam =
      new InputPortPtr() {
        public void handler() {
          PORT_START(); /* DSW0 */
  ...
  static MachineDriver machine_driver_gundealr =
      new MachineDriver(
          ...
          0,
          0,
          new MachineSound[] {new MachineSound(SOUND_YM2203, ym2203_interface)});
  ...
  static RomLoadPtr rom_gundealr =
      new RomLoadPtr() {
        public void handler() {
  ...
  static RomLoadPtr rom_gundeala =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x30000, REGION_CPU1); /* 64k for code + 128k for banks */
  ...
  public static InitDriverPtr init_gundealr =
      new InitDriverPtr() {
        public void handler() {
          input_ports_hack = 0;
        }
  ...
  public static InitDriverPtr init_yamyam =
      new InitDriverPtr() {
        public void handler() {
          input_ports_hack = 1;
  ...
  public static GameDriver driver_gundealr =
      new GameDriver(
          "1990",
          "gundealr",
          "gundealr.java",
          rom_gundealr,
          null,
          machine_driver_gundealr,
          input_ports_gundealr,
          init_gundealr,
          ROT270,
          "Dooyong",
          "Gun Dealer (set 1)");
  public static GameDriver driver_gundeala =
      new GameDriver(
          "????",
          "gundeala",
          "gundealr.java",
          ...
          "Dooyong",
          "Gun Dealer (set 2)");
  public static GameDriver driver_yamyam =
      new GameDriver(
          "1990",
          "yamyam",
          "gundealr.java",
          ...
          "Dooyong",
          "Yam! Yam!?");
  public static GameDriver driver_wiseguy =
      new GameDriver(
          "1990",
          "wiseguy",
          "gundealr.java",
