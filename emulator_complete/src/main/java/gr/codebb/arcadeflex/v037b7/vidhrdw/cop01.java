...
public class cop01 {
  ...
  public static VhConvertColorPromPtr cop01_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(2); i++) {
            colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] =
                (char) (((color_prom.readinc()) & 0x0f) + 128);
          }
        }
      };
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr cop01_vh_start =
      new VhStartPtr() {
        public int handler() {
          ...
          if ((tmpbitmap2 = bitmap_alloc(2 * Machine.drv.screen_width, Machine.drv.screen_height))
              == null) {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr cop01_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr cop01_scrollx_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr cop01_gfxbank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr cop01_vh_screenrefresh =
      new VhUpdatePtr() {
