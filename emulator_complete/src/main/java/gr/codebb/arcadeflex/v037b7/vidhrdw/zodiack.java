...
public class zodiack {
  ...
  public static VhConvertColorPromPtr zodiack_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(0); i += 2) {
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] =
                (char) ((32 + (i / 2)));
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + (i + 1)] =
                (char) ((40 + (i / 2)));
          }
  ...
  public static WriteHandlerPtr zodiac_flipscreen_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr zodiac_control_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr zodiack_vh_screenrefresh =
      new VhUpdatePtr() {
