...
public class hexa {
  ...
  static InputPortPtr input_ports_hexa =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_hexa =
      new MachineDriver(
  ...
  public static InitDriverPtr init_hexa =
      new InitDriverPtr() {
        public void handler() {
  ...
  public static GameDriver driver_hexa =
      new GameDriver(
          "????",
          "hexa",
          "hexa.java",
