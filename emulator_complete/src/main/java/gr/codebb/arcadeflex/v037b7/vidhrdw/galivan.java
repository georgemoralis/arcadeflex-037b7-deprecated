...
public class galivan {
  ...
  public static VhConvertColorPromPtr galivan_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(1); i++) {
            if ((i & 8) != 0) {
              colortable[Machine.drv.gfxdecodeinfo[1].color_codes_start + i] =
                  (char) (192 + (i & 0x0f) + ((i & 0xc0) >> 2));
            } else {
              colortable[Machine.drv.gfxdecodeinfo[1].color_codes_start + i] =
                  (char) (192 + (i & 0x0f) + ((i & 0x30) >> 0));
            }
          }
          ...
          for (i = 0; i < TOTAL_COLORS(2) / 16; i++) {
            ...
            for (j = 0; j < 16; j++) {
              if ((i & 8) != 0) {
                colortable[
                        Machine.drv.gfxdecodeinfo[2].color_codes_start
                            + i
                            + j * (TOTAL_COLORS(2) / 16)] =
                    (char) (128 + ((j & 0x0c) << 2) + (color_prom.read() & 0x0f));
                // COLOR(2,i + j * (TOTAL_COLORS(2)/16)) = 128 + ((j & 0x0c) << 2) + (*color_prom &
                // 0x0f);
              } else {
                colortable[
                        Machine.drv.gfxdecodeinfo[2].color_codes_start
                            + i
                            + j * (TOTAL_COLORS(2) / 16)] =
                    (char) (128 + ((j & 0x03) << 4) + (color_prom.read() & 0x0f));
                // COLOR(2,i + j * (TOTAL_COLORS(2)/16)) = 128 + ((j & 0x03) << 4) + (*color_prom &
                // 0x0f);
              }
            }
            color_prom.inc();
  ...
  public static GetTileInfoPtr get_tx_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
  ...
  public static GetTileInfoPtr ninjemak_get_bg_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
          UBytePtr BGROM = memory_region(REGION_GFX4);
          int attr = BGROM.read(tile_index + 0x4000);
  ...
  public static GetTileInfoPtr ninjemak_get_tx_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
          int attr = colorram.read(tile_index);
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr galivan_vh_start =
      new VhStartPtr() {
        public int handler() {
          bg_tilemap =
              tilemap_create(get_bg_tile_info, tilemap_scan_rows, TILEMAP_OPAQUE, 16, 16, 128, 128);
          tx_tilemap =
              tilemap_create(
                  get_tx_tile_info, tilemap_scan_cols, TILEMAP_TRANSPARENT, 8, 8, 32, 32);
  ...
  public static VhStartPtr ninjemak_vh_start =
      new VhStartPtr() {
        public int handler() {
          bg_tilemap =
              tilemap_create(
                  ninjemak_get_bg_tile_info, tilemap_scan_cols, TILEMAP_OPAQUE, 16, 16, 512, 32);
          tx_tilemap =
              tilemap_create(
                  ninjemak_get_tx_tile_info, tilemap_scan_cols, TILEMAP_TRANSPARENT, 8, 8, 32, 32);
   ...
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr galivan_videoram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr galivan_colorram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr galivan_gfxbank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr ninjemak_gfxbank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          /* bits 0 and 1 coin counters */
          coin_counter_w.handler(0, data & 1);
  ...
  public static WriteHandlerPtr galivan_scrollx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr galivan_scrolly_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr ninjemak_scrollx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          scrollx[offset] = (char) (data & 0xFF);
        }
  ...
  public static WriteHandlerPtr ninjemak_scrolly_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          scrolly[offset] = (char) (data & 0xFF);
        }
  ...
  public static VhUpdatePtr galivan_vh_screenrefresh =
      new VhUpdatePtr() {
  ...
  public static VhUpdatePtr ninjemak_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
