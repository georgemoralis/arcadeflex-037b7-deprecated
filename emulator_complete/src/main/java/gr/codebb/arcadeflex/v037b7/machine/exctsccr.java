...
public class exctsccr {
  ...
  public static WriteHandlerPtr exctsccr_mcu_control_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          ...
          if (data == 0xff) {
            ...
            mcu_sort_list(
                new UBytePtr(exctsccr_mcu_ram, 0x03e0), new UBytePtr(exctsccr_mcu_ram, 0x0300));
  ...
  public static WriteHandlerPtr exctsccr_mcu_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
