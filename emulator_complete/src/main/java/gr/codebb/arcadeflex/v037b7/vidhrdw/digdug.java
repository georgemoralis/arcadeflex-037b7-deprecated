...
public class digdug {
   ...
   *
   * <p>digdug has one 32x8 palette PROM and two 256x4 color lookup table PROMs (one for characters,
   * one for sprites). Only the first 128 bytes of the lookup tables seem to be used. The palette
   * PROM is connected to the RGB output this way:
   *
   ...
   * <p>*************************************************************************
   */
  public static VhConvertColorPromPtr digdug_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr digdug_vh_start =
      new VhStartPtr() {
        public int handler() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr digdug_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr digdug_vh_latch_w =
      new WriteHandlerPtr() {
  ...
  public static void digdug_draw_sprite(
      osd_bitmap dest, int code, int color, int flipx, int flipy, int sx, int sy) {
    drawgfx(
        dest,
        Machine.gfx[1],
        code,
  ...
  public static WriteHandlerPtr digdug_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr digdug_vh_screenrefresh =
      new VhUpdatePtr() {
