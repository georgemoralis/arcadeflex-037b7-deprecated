...
public class bosco {
  ...
  public static InitMachinePtr bosco_init_machine =
      new InitMachinePtr() {
        public void handler() {
          credits = 0;
          HiScore = 20000;
  ...
  public static ReadHandlerPtr bosco_sharedram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr bosco_sharedram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr bosco_dsw_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          int bit0, bit1;
  ...
  public static WriteHandlerPtr bosco_customio_data_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr bosco_customio_data_1_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          switch (customio_command_1) {
            case 0x71:
  ...
  public static ReadHandlerPtr bosco_customio_1_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static timer_callback bosco_nmi_generate_1 =
      new timer_callback() {
  ...
  public static WriteHandlerPtr bosco_customio_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if (data != 0x10) {
   ...
   * *************************************************************************
   *
   * <p>Emulate the second (!) custom IO chip.
   *
   * <p>*************************************************************************
   */
  ...
  public static WriteHandlerPtr bosco_customio_data_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static ReadHandlerPtr bosco_customio_data_2_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
          switch (customio_command_2) {
            case 0x91:
  ...
  public static ReadHandlerPtr bosco_customio_2_r =
      new ReadHandlerPtr() {
        public int handler(int offset) {
  ...
  public static timer_callback bosco_nmi_generate_2 =
      new timer_callback() {
        public void handler(int trigger) {
  ...
  public static WriteHandlerPtr bosco_customio_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if (data != 0x10) {
  ...
  public static WriteHandlerPtr bosco_halt_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          if ((data & 1) != 0) {
  ...
  public static WriteHandlerPtr bosco_interrupt_enable_1_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr bosco_interrupt_1 =
      new InterruptPtr() {
        public int handler() {
          bosco_vh_interrupt();
  ...
  public static WriteHandlerPtr bosco_interrupt_enable_2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr bosco_interrupt_2 =
      new InterruptPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr bosco_interrupt_enable_3_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static InterruptPtr bosco_interrupt_3 =
      new InterruptPtr() {
        public int handler() {
