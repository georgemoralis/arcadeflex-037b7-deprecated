...
public class goindol {
  ...
  public static VhConvertColorPromPtr goindol_vh_convert_color_prom =
  ...
  public static WriteHandlerPtr goindol_fg_videoram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr goindol_bg_videoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static VhStartPtr goindol_vh_start =
      new VhStartPtr() {
        public int handler() {
          ...
          if ((bitmap_fg = bitmap_alloc(Machine.drv.screen_width, Machine.drv.screen_height))
              == null) {
            fg_dirtybuffer = null;
            bg_dirtybuffer = null;
            return 1;
          }
          if ((bitmap_bg = bitmap_alloc(Machine.drv.screen_width, Machine.drv.screen_height))
              == null) {
  ...
  public static VhStopPtr goindol_vh_stop =
      new VhStopPtr() {
        public void handler() {
          fg_dirtybuffer = null;
          bg_dirtybuffer = null;
    ...
    for (x = 0; x < 32; x++) {
      for (y = 0; y < 32; y++) {
        ...
        if (bg_dirtybuffer[offs >> 1] != 0) {
          ...
          tile = ((hi & 0x7) << 8) | lo;
          palette = hi >> 3;
          drawgfx(bitmap, Machine.gfx[1], tile, palette, 0, 0, sx, sy, null, TRANSPARENCY_NONE, 0);
        }
      }
    }
  }
  ...
  public static VhUpdatePtr goindol_vh_screenrefresh =
      new VhUpdatePtr() {
