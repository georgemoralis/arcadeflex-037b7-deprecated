...
public class blktiger {
   ...
   * <p>*************************************************************************
   */
  public static GetMemoryOffsetPtr bg8x4_scan =
      new GetMemoryOffsetPtr() {
  ...
  public static GetMemoryOffsetPtr bg4x8_scan =
      new GetMemoryOffsetPtr() {
        public int handler(int u32_col, int u32_row, int u32_num_cols, int u32_num_rows) {
          /* logical (col,row) . memory offset */
          return (u32_col & 0x0f)
  ...
  public static GetTileInfoPtr get_tx_tile_info =
      new GetTileInfoPtr() {
        public void handler(int tile_index) {
          ...
          SET_TILE_INFO(
              0, blktiger_txvideoram.read(tile_index) + ((attr & 0xe0) << 3), attr & 0x1f);
        }
      };
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr blktiger_vh_stop =
      new VhStopPtr() {
        public void handler() {
          scroll_ram = null;
        }
  ...
  public static VhStartPtr blktiger_vh_start =
      new VhStartPtr() {
        public int handler() {
          ...
          tx_tilemap =
              tilemap_create(
                  get_tx_tile_info, tilemap_scan_rows, TILEMAP_TRANSPARENT, 8, 8, 32, 32);
          bg_tilemap8x4 =
              tilemap_create(
                  get_bg_tile_info,
                  bg8x4_scan,
          ...
          bg_tilemap8x4.transparent_pen = bg_tilemap4x8.transparent_pen = 15;

          bg_tilemap8x4.u32_transmask[0] = bg_tilemap4x8.u32_transmask[0] = 0xffff;
          /* split type 0 is totally transparent in front half */
          bg_tilemap8x4.u32_transmask[1] = bg_tilemap4x8.u32_transmask[1] = 0xfff0;
          /* split type 1 has pens 4-15 transparent in front half */
          bg_tilemap8x4.u32_transmask[2] = bg_tilemap4x8.u32_transmask[2] = 0xff00;
          /* split type 1 has pens 8-15 transparent in front half */
          bg_tilemap8x4.u32_transmask[3] = bg_tilemap4x8.u32_transmask[3] = 0xf000;
   ...
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr blktiger_txvideoram_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr blktiger_bgvideoram_r =
      new ReadHandlerPtr() {
  ...
  public static WriteHandlerPtr blktiger_bgvideoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr blktiger_bgvideoram_bank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr blktiger_scrolly_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          int scrolly;
  ...
  public static WriteHandlerPtr blktiger_scrollx_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          int scrollx;
  ...
  public static WriteHandlerPtr blktiger_video_control_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr blktiger_video_enable_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr blktiger_screen_layout_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          screen_layout = data;
  ...
  public static VhUpdatePtr blktiger_vh_screenrefresh =
      new VhUpdatePtr() {
  ...
  public static VhEofCallbackPtr blktiger_eof_callback =
      new VhEofCallbackPtr() {
        public void handler() {
