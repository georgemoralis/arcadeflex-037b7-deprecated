...
public class solomon {
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr solomon_vh_start =
      new VhStartPtr() {
        public int handler() {
          int i;
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr solomon_vh_stop =
      new VhStopPtr() {
        public void handler() {
          bitmap_free(tmpbitmap2);
          dirtybuffer2 = null;
  ...
  public static WriteHandlerPtr solomon_bgvideoram_w =
      new WriteHandlerPtr() {
  ...
  public static WriteHandlerPtr solomon_bgcolorram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr solomon_flipscreen_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr solomon_vh_screenrefresh =
      new VhUpdatePtr() {
