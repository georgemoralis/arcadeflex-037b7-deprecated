...
public class cclimber {
   ...
   *
   * <p>Crazy Climber has three 32x8 palette PROMs. The palette PROMs are connected to the RGB
   * output this way:
   *
   * <p>bit 7 -- 220 ohm resistor -- BLUE -- 470 ohm resistor -- BLUE -- 220 ohm resistor -- GREEN
   * -- 470 ohm resistor -- GREEN -- 1 kohm resistor -- GREEN -- 220 ohm resistor -- RED -- 470 ohm
  ...
  public static VhConvertColorPromPtr cclimber_vh_convert_color_prom =
   ...
   * <p>Convert the color PROMs into a more useable format.
   *
   * <p>Swimmer has two 256x4 char/sprite palette PROMs and one 32x8 big sprite palette PROM. The
   * palette PROMs are connected to the RGB output this way: (the 500 and 250 ohm resistors are made
   * of 1 kohm resistors in parallel)
   *
   * <p>bit 3 -- 250 ohm resistor -- BLUE -- 500 ohm resistor -- BLUE -- 250 ohm resistor -- GREEN
   * bit 0 -- 500 ohm resistor -- GREEN bit 3 -- 1 kohm resistor -- GREEN -- 250 ohm resistor -- RED
   * -- 500 ohm resistor -- RED bit 0 -- 1 kohm resistor -- RED
   *
   * <p>bit 7 -- 250 ohm resistor -- BLUE -- 500 ohm resistor -- BLUE -- 250 ohm resistor -- GREEN
   * -- 500 ohm resistor -- GREEN -- 1 kohm resistor -- GREEN -- 250 ohm resistor -- RED -- 500 ohm
   * resistor -- RED bit 0 -- 1 kohm resistor -- RED
   *
   * <p>Additionally, the background color of the score panel is determined by these resistors:
   *
   * <p>/--- tri-state -- 470 -- BLUE +5V -- 1kohm ------- tri-state -- 390 -- GREEN \--- tri-state
   * -- 1000 -- RED
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr swimmer_vh_convert_color_prom =
      new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          int i;
          int p_ptr = 0;
          for (i = 0; i < 256; i++) {
            ...
            if ((i % 8) != 0) {
              ...
              colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i + 256] =
                  (char) (SIDEPEN);
            }
          }
   ...
   * *************************************************************************
   *
   * <p>Swimmer can directly set the background color. The latch is connected to the RGB output this
   * way: (the 500 and 250 ohm resistors are made of 1 kohm resistors in parallel)
   *
   * <p>bit 7 -- 250 ohm resistor -- RED -- 500 ohm resistor -- RED -- 250 ohm resistor -- GREEN --
   * 500 ohm resistor -- GREEN -- 1 kohm resistor -- GREEN -- 250 ohm resistor -- BLUE -- 500 ohm
   * resistor -- BLUE bit 0 -- 1 kohm resistor -- BLUE
   *
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr swimmer_bgcolor_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr cclimber_vh_start =
      new VhStartPtr() {
        public int handler() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr cclimber_vh_stop =
      new VhStopPtr() {
        public void handler() {
  ...
  public static WriteHandlerPtr cclimber_colorram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr cclimber_bigsprite_videoram_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr swimmer_palettebank_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr swimmer_sidepanel_enable_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  static void drawbigsprite(osd_bitmap bitmap) {
    ...
    sy &= 0xff;
    copybitmap(
        bitmap, bsbitmap, flipx, flipy, sx, sy, Machine.visible_area, TRANSPARENCY_COLOR, bgpen);
    copybitmap(
        bitmap,
        bsbitmap,
        flipx,
  ...
  public static VhUpdatePtr cclimber_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = videoram_size[0] - 1; offs >= 0; offs--) {
            if (dirtybuffer[offs] != 0) {
              ...
              drawgfx(
                  tmpbitmap,
                  Machine.gfx[(colorram.read(offs) & 0x10) != 0 ? 1 : 0],
          ...
          /* copy the temporary bitmap to the screen */
          {
            ...
            copyscrollbitmap(
                bitmap, tmpbitmap, 0, null, 32, scroll, Machine.visible_area, TRANSPARENCY_NONE, 0);
          }
          ...
          for (offs = spriteram_size[0] - 4; offs >= 0; offs -= 4) {
            ...
            drawgfx(
                bitmap,
                Machine.gfx[(spriteram.read(offs + 1) & 0x10) != 0 ? 4 : 3],
  ...
  public static VhUpdatePtr swimmer_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          int offs;
