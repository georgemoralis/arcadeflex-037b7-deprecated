...
public class appoooh {
   ...
   *
   * <p>Palette information of appoooh is not known.
   *
   * <p>The palette decoder of Bank Panic was used for this driver. Because these hardware is
   * similar.
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr appoooh_vh_convert_color_prom =
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr appoooh_vh_start =
      new VhStartPtr() {
        public int handler() {
  ...
  public static WriteHandlerPtr appoooh_scroll_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhStopPtr appoooh_vh_stop =
      new VhStopPtr() {
        public void handler() {
          dirtybuffer2 = null;
  ...
  public static WriteHandlerPtr appoooh_videoram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr appoooh_colorram2_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
  ...
  public static WriteHandlerPtr appoooh_out_w =
      new WriteHandlerPtr() {
        public void handler(int offset, int data) {
          /* bit 0 controls NMI */
          if ((data & 0x01) != 0) {
  ...
  public static void appoooh_draw_sprites(osd_bitmap dest_bmp, GfxElement gfx, UBytePtr sprite) {
    int offs;
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr appoooh_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = videoram_size[0] - 1; offs >= 0; offs--) {
            ...
            if (dirtybuffer2[offs] != 0) {
              ...
              sy = offs / 32;
              code =
                  appoooh_videoram2.read(offs) + 256 * ((appoooh_colorram2.read(offs) >> 5) & 0x07);
