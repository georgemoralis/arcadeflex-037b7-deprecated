...
public class mrjong {
   ...
   * *************************************************************************
   *
   * <p>Convert the color PROMs. (from vidhrdw/penco.c)
   *
   * <p>*************************************************************************
   */
  ...
  public static VhConvertColorPromPtr mrjong_vh_convert_color_prom =
   ...
   * *************************************************************************
   *
   * <p>Display control parameter.
   *
   * <p>*************************************************************************
   */
  public static WriteHandlerPtr mrjong_flipscreen_w =
      new WriteHandlerPtr() {
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr mrjong_vh_screenrefresh =
      new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
          ...
          for (offs = (spriteram_size[0] - 4); offs >= 0; offs -= 4) {
            ...
            sprt =
                (((spriteram.read(offs + 1) >> 2) & 0x3f)
                    | ((spriteram.read(offs + 3) & 0x20) << 1));
