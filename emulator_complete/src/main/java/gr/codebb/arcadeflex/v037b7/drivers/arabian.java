...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.arabian.*;
...
public class arabian {
  ...
  public static InterruptPtr arabian_interrupt =
      new InterruptPtr() {
        public int handler() {
  ...
  static int last;
  public static WriteHandlerPtr arabian_portB_w =
      new WriteHandlerPtr() {
  ...
  public static ReadHandlerPtr arabian_input_port_r =
      new ReadHandlerPtr() {
  ...
  static InputPortPtr input_ports_arabian =
      new InputPortPtr() {
        public void handler() {
          PORT_START();
          /* IN0 */
  ...
  static MachineDriver machine_driver_arabian =
      new MachineDriver(
  ...
  static RomLoadPtr rom_arabian =
      new RomLoadPtr() {
        public void handler() {
          ...
          /* it at runtime - which is SLOW */
          ROM_END();
        }
      };

  static RomLoadPtr rom_arabiana =
      new RomLoadPtr() {
        public void handler() {
          ROM_REGION(0x10000, REGION_CPU1);
          /* 64k for code */
  ...
  public static GameDriver driver_arabian =
      new GameDriver(
          "1983",
          "arabian",
          "arabian.java",
          rom_arabian,
          null,
          machine_driver_arabian,
          input_ports_arabian,
          null,
          ROT270,
          "Sun Electronics",
          "Arabian",
          GAME_IMPERFECT_COLORS | GAME_NO_COCKTAIL);
  public static GameDriver driver_arabiana =
      new GameDriver(
          "1983",
          "arabiana",
          "arabian.java",
