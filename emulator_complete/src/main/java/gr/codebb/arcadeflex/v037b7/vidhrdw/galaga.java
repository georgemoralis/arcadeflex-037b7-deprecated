...
public class galaga {
   ...
   *
   * <p>Galaga has one 32x8 palette PROM and two 256x4 color lookup table PROMs (one for characters,
  ...
  public static VhConvertColorPromPtr galaga_vh_convert_color_prom =
        ...
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
          ...
          for (i = 0; i < TOTAL_COLORS(0); i++) {
            colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] =
                (char) (15 - (color_prom.readinc() & 0x0f));
          }
          ...
          for (i = 0; i < TOTAL_COLORS(1); i++) {
            if (i % 4 == 0) {
              ...
              colortable[Machine.drv.gfxdecodeinfo[1].color_codes_start + i] =
                  (char) (15 - ((color_prom.read() & 0x0f)) + 0x10);
            }
   ...
   * <p>*************************************************************************
   */
  public static VhStartPtr galaga_vh_start =
      new VhStartPtr() {
        public int handler() {
          int generator;
          int x, y;
   ...
   * <p>*************************************************************************
   */
  public static VhUpdatePtr galaga_vh_screenrefresh =
      new VhUpdatePtr() {
