...
public class commonH {
    ...
    public static class RomModule {
        ...
        public /*UINT32*/ int offset;/* offset to load it to */
        public /*UINT32*/ int length;/* length of the file */
        public /*UINT32*/ int crc;/* standard CRC-32 checksum */
 ...
 /* Masks for individual ROMs */
    ...
    public static final int REGIONFLAG_SOUNDONLY = 0x40000000;/* load only if sound_old emulation is turned on */
