...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptport.inputport_vblank_end;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptport.update_input_ports;
...
public class cpuintrf {
    ...
    public static ArrayList<cpuinfo> cpu = new ArrayList<cpuinfo>();//static cpuinfo cpu_old[MAX_CPU];
...
/*TODO*///	#define SETSP(index,val)				((*cpu_old[index].intf.set_sp)(val))
    ...
    /*TODO*///	#define INTERNAL_INTERRUPT(index,type)	if( cpu_old[index].intf.internal_interrupt ) ((*cpu_old[index].intf.internal_interrupt)(type))
/*TODO*///	#define CPUINFO(index,context,regnum)	((*cpu_old[index].intf.cpu_info)(context,regnum))
/*TODO*///	#define CPUDASM(index,buffer,pc)		((*cpu_old[index].intf.cpu_dasm)(buffer,pc))
    ...
    /*TODO*///	#define READMEM(index,offset)			((*cpu_old[index].intf.memory_read)(offset))
/*TODO*///	#define WRITEMEM(index,offset,data) 	((*cpu_old[index].intf.memory_write)(offset,data))
...
/*TODO*///	#define CPU0(cpu_old,name,nirq,dirq,oc,i0,i1,i2,mem,shift,bits,endian,align,maxinst,MEM) \
/*TODO*///		{																			   \
/*TODO*///			CPU_##cpu_old,																   \
...
/*TODO*///	#define CPU1(cpu_old,name,nirq,dirq,oc,i0,i1,i2,mem,shift,bits,endian,align,maxinst,MEM)   \
/*TODO*///		{																			   \
/*TODO*///			CPU_##cpu_old,																   \
...
/*TODO*///	#define CPU2(cpu_old,name,nirq,dirq,oc,i0,i1,i2,mem,shift,bits,endian,align,maxinst,MEM)   \
/*TODO*///		{																			   \
/*TODO*///			CPU_##cpu_old,																   \
/*TODO*///			name##_reset, name##_exit, name##_execute,								   \
/*TODO*///			NULL,																	   \
...
/*TODO*///	
    ...
    public static cpu_interface cpuintf[]
            = {
                ...
                new Dummy_cpu(),/*TODO*///		CPU0(N2A03,    n2a03,	 1,  0,1.00,N2A03_INT_NONE,    N2A03_INT_IRQ,  N2A03_INT_NMI,  16,	  0,16,LE,1, 3,16	),
                ...
                new Dummy_cpu(),/*TODO*///		CPU0(V33,	   v33, 	 1,  0,1.20,NEC_INT_NONE,	   -1000,		   NEC_NMI_INT,    20,	  0,20,LE,1, 5,20	),
                new Dummy_cpu(),/*TODO*///		CPU0(I8035,    i8035,	 1,  0,1.00,I8035_IGNORE_INT,  I8035_EXT_INT,  -1,			   16,	  0,16,LE,1, 2,16	),
                new Dummy_cpu(),/*TODO*///		CPU0(I8039,    i8039,	 1,  0,1.00,I8039_IGNORE_INT,  I8039_EXT_INT,  -1,			   16,	  0,16,LE,1, 2,16	),
                ...
                new Dummy_cpu(),/*TODO*///		CPU0(HD6309,   hd6309,	 2,  0,1.00,HD6309_INT_NONE,   HD6309_INT_IRQ, HD6309_INT_NMI, 16,	  0,16,BE,1, 4,16	),
                new Dummy_cpu(),
                new Dummy_cpu(),/*TODO*///		CPU0(KONAMI,   konami,	 2,  0,1.00,KONAMI_INT_NONE,   KONAMI_INT_IRQ, KONAMI_INT_NMI, 16,	  0,16,BE,1, 4,16	),
                new Dummy_cpu(),/*TODO*///		CPU0(M68000,   m68000,	 8, -1,1.00,MC68000_INT_NONE,  -1,			   -1,			   24bew, 0,24,BE,2,10,24BEW),
                ...
                new Dummy_cpu(),/*TODO*///		CPU0(TMS320C10,tms320c10,2,  0,1.00,TMS320C10_INT_NONE,-1,			   -1,			   16,	 -1,16,BE,2, 4,16	),
                new Dummy_cpu(),/*TODO*///		CPU0(CCPU,	   ccpu,	 2,  0,1.00,0,				   -1,			   -1,			   16,	  0,15,LE,1, 3,16	),
                ...
                new Dummy_cpu(),/*TODO*///		CPU0(ADSP2100, adsp2100, 4,  0,1.00,ADSP2100_INT_NONE, -1,			   -1,			   16lew,-1,14,LE,2, 4,16LEW),
                /*TODO*///	/* IMO we should rename all *_ICount to *_icount - ie. no mixed case */
                /*TODO*///	#define adsp2105_ICount adsp2105_icount
                new Dummy_cpu(),/*TODO*///		CPU0(ADSP2105, adsp2105, 4,  0,1.00,ADSP2105_INT_NONE, -1,			   -1,			   16lew,-1,14,LE,2, 4,16LEW),
                new Dummy_cpu(),/*TODO*///		CPU0(MIPS,	   mips,	 8, -1,1.00,MIPS_INT_NONE,	   MIPS_INT_NONE,  MIPS_INT_NONE,  32lew, 0,32,LE,4, 4,32LEW),
                /*TODO*///	#if (HAS_SC61860)
...
/*TODO*///	
    ...
    public static void cpu_run() {
        ...
        for (int i = 0; i < totalcpu; i++) {
            cpu.get(i).context = cpu.get(i).intf.init_context(); //not in mame_old but proper for arcadeflex_old
/*TODO*///			int j, size;
/*TODO*///	
...
/*TODO*///			}
/*TODO*///	
/*TODO*///			cpu_old[i].context = malloc( size );
/*TODO*///			if( cpu_old[i].context == NULL )
/*TODO*///			{
...
/*TODO*///			memset(cpu_old[i].context, 0, size );
/*TODO*///
...
/*TODO*///			if( cpu_old[i].intf.exit )
/*TODO*///				(*cpu_old[i].intf.exit)();
/*TODO*///
/*TODO*///			/* free the context buffer for that CPU */
/*TODO*///			if( cpu_old[i].context )
/*TODO*///			{
/*TODO*///				free( cpu_old[i].context );
/*TODO*///				cpu_old[i].context = NULL;
/*TODO*///			}
            }
            totalcpu = 0;
            break;
...
/*TODO*///	
     ...
     * *************************************************************************
     */
    /*TODO*///    public static void cpu_generate_internal_interrupt(int cpunum, int type) {
...
/*TODO*///    }
    ...
    /*TODO*///	public static InterruptPtr m68_level1_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_1;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level2_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_2;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level3_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_3;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level4_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_4;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level5_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_5;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level6_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
/*TODO*///		return MC68000_IRQ_6;
/*TODO*///	} };
/*TODO*///	public static InterruptPtr m68_level7_irq = new InterruptPtr() { public int handler() 
/*TODO*///	{
/*TODO*///		int cpunum = (activecpu < 0) ? 0 : activecpu;
/*TODO*///		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
...
/*TODO*///		if (cpu_old[activecpu].save_context) SETCONTEXT(activecpu, cpu_old[activecpu].context);
/*TODO*///	
/*TODO*///		INTERNAL_INTERRUPT(cpunum, type);
/*TODO*///	
/*TODO*///		/* update the CPU's context */
/*TODO*///		if (cpu_old[activecpu].save_context) GETCONTEXT(activecpu, cpu_old[activecpu].context);
...
/*TODO*///	{
/*TODO*///		return (cpu_old[_activecpu].save_context);
/*TODO*///	}
/*TODO*///	
/*TODO*///	
/*TODO*///	/* JB 971019 */
...
/*TODO*///	{
/*TODO*///		return cpu_old[_activecpu].context;
/*TODO*///	}
/*TODO*///	
/*TODO*///	
/*TODO*///	/***************************************************************************
...
/*TODO*///	}
    ...
    /**
     * *************************************************************************
     * Set a register value for a specific CPU number of the running machine_old
     * *************************************************************************
     */
