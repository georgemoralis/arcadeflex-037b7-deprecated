...
import static gr.codebb.arcadeflex.old.mame.cpuintrf.cpu_gethorzbeampos;
...
public class exerion
{
	...
	***************************************************************************/
	...
	public static VhUpdatePtr exerion_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int sx, sy, offs, i;
