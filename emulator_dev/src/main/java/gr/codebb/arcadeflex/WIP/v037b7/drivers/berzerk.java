...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.berzerk.*;
...
import static gr.codebb.arcadeflex.WIP.v037b7.sndhrdw.berzerk.*;
import static gr.codebb.arcadeflex.WIP.v037b7.sound.samplesH.*;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.berzerk.*;
...
public class berzerk {
    ...
    static InputPortPtr input_ports_berzerk = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortPtr input_ports_frenzy = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY);
