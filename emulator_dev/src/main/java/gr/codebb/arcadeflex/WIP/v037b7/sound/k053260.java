...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.k053260H.*;
...
public class k053260 extends snd_interface {
    ...
    public int start(MachineSound msound) {
        ...
        K053260_chip.mode = 0;
        K053260_chip.rom = new UBytePtr(memory_region(K053260_chip.intf.region));
...
/*TODO*///                fprintf(errorlog, "K53260: Attempting to start playing past the end of the rom ( start = %06x, end = %06x ).\n", channel_start, channel_end);
/*TODO*///            }
...
/*TODO*///            if (errorlog != null) {
/*TODO*///                fprintf(errorlog, "K53260: Attempting to play past the end of the rom ( start = %06x, end = %06x ).\n", channel_start, channel_end);
/*TODO*///            }
...
//#endif
    ...
    public static WriteHandlerPtr K053260_w = new WriteHandlerPtr() {
        public void handler(int r, int v) {
            ...
            if (r > 0x2f) {
/*TODO*///                if (errorlog != null) {
/*TODO*///                    fprintf(errorlog, "K053260: Writing past registers\n");
/*TODO*///                }
                return;
            }
...
/*TODO*///                            if (errorlog != null) {
/*TODO*///                                fprintf(errorlog, "K53260: Attempting to read past rom size on rom Read Mode.\n");
/*TODO*///                            }
