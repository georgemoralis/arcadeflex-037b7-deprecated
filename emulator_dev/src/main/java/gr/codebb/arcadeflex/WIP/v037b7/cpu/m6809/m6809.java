...
/*TODO*///	#endif
    ...
    public static final int M6809_CWAI = 8;
    /* set when CWAI is waiting for an interrupt */
    public static final int M6809_SYNC = 16;
    /* set when SYNC is waiting for an interrupt */
    public static final int M6809_LDS = 32;
 ...
 /* HJB 990225: state already saved by CWAI? */
            if ((_m6809.int_state & M6809_CWAI) != 0) {
                ...
                PUSHWORD(_m6809.pc);
                PUSHBYTE(_m6809.cc);
                _m6809.extra_cycles += 10;
                /* subtract +10 cycles */
            }
            _m6809.cc |= CC_IF | CC_II;
 ...
 /* HJB 990225: state already saved by CWAI? */
    ...
    public void CLR_HNZVC() {
        _m6809.cc &= ~(CC_H | CC_N | CC_Z | CC_V | CC_C);
    }

    public void CLR_NZV() {
        _m6809.cc &= ~(CC_N | CC_Z | CC_V);
    }

    /*TODO*///#define CLR_HNZC	CC&=~(CC_H|CC_N|CC_Z|CC_C)
    public void CLR_NZVC() {
        _m6809.cc &= ~(CC_N | CC_Z | CC_V | CC_C);
    }
    ...
    public void SET_N16(int a) {
        _m6809.cc |= ((a & 0x8000) >> 12);
    }

    public void SET_H(int a, int b, int r) {
        _m6809.cc |= (((a ^ b ^ r) & 0x10) << 1);
    }
    ...
    public void SET_C16(int a) {
        _m6809.cc |= ((a & 0x10000) >> 16);
    }

    public void SET_V8(int a, int b, int r) {
        _m6809.cc |= (((a ^ b ^ r ^ (r >> 1)) & 0x80) >> 6);
    }

    public void SET_V16(int a, int b, int r) {
        _m6809.cc |= (((a ^ b ^ r ^ (r >> 1)) & 0x8000) >> 14);
    }
    ...
    public void SET_FLAGS8I(int a) {
        _m6809.cc |= flags8i[(a) & 0xff];
    }

    public void SET_FLAGS8D(int a) {
        _m6809.cc |= flags8d[(a) & 0xff];
    }
    ...
    public int NXORV() {
        return ((_m6809.cc & CC_N) ^ ((_m6809.cc & CC_V) << 2));
    }
    ...
    public int m6809_get_reg(int regnum) {
        switch (regnum) {
            ...
            case M6809_NMI_STATE:
                return _m6809.nmi_state;
            case M6809_IRQ_STATE:
                return _m6809.irq_state[M6809_IRQ_LINE];
            case M6809_FIRQ_STATE:
                return _m6809.irq_state[M6809_FIRQ_LINE];
            case REG_PREVIOUSPC:
                return _m6809.ppc;
            default:
...
/*TODO*///	}
    ...
    public void m6809_set_nmi_line(int state) {
        ...
        if ((_m6809.int_state & M6809_LDS) == 0) {
            return;
        }
    ...
    public int m6809_execute(int cycles) /* NS 970908 */ {
        ...
        if ((_m6809.int_state & (M6809_CWAI | M6809_SYNC)) != 0) {
            ...
            do {
                ...
                _m6809.ireg = ROP(_m6809.pc) & 0xFF;
                _m6809.pc = (char) ((_m6809.pc + 1) & 0xFFFF);
                /*TODO*///	#if BIG_SWITCH
    ...
    public void fetch_effective_address() {
        ...
        switch (postbyte) {
            case 0x00:
                ...
                break;
            case 0x01:
                ea = _m6809.x + 1 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x02:
                ea = _m6809.x + 2 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x03:
                ea = _m6809.x + 3 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x04:
                ea = _m6809.x + 4 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x05:
                ea = _m6809.x + 5 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x06:
                ea = _m6809.x + 6 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x07:
                ea = _m6809.x + 7 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x08:
                ea = _m6809.x + 8 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x09:
                ea = _m6809.x + 9 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0a:
                ea = _m6809.x + 10 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0b:
                ea = _m6809.x + 11 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0c:
                ea = _m6809.x + 12 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0d:
                ea = _m6809.x + 13 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0e:
                ea = _m6809.x + 14 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x0f:
                ea = _m6809.x + 15 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;

            case 0x10:
                ea = _m6809.x - 16 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x11:
                ea = _m6809.x - 15 & 0xFFFF;
            ...
            case 0x20:
                ...
                break;
            case 0x21:
                ea = _m6809.y + 1 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x22:
                ea = _m6809.y + 2 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x23:
                ea = _m6809.y + 3 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x24:
                ea = _m6809.y + 4 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x25:
                ea = _m6809.y + 5 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x26:
                ea = _m6809.y + 6 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x27:
                ea = _m6809.y + 7 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x28:
                ea = _m6809.y + 8 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x29:
                ea = _m6809.y + 9 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2a:
                ea = _m6809.y + 10 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2b:
                ea = _m6809.y + 11 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2c:
                ea = _m6809.y + 12 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2d:
                ea = _m6809.y + 13 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2e:
                ea = _m6809.y + 14 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x2f:
                ea = _m6809.y + 15 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;

            case 0x30:
                ea = _m6809.y - 16 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x31:
                ea = _m6809.y - 15 & 0xFFFF;
            ...
            case 0x40:
                ...
                break;
            case 0x41:
                ea = _m6809.u + 1 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x42:
                ea = _m6809.u + 2 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x43:
                ea = _m6809.u + 3 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x44:
                ea = _m6809.u + 4 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x45:
                ea = _m6809.u + 5 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x46:
                ea = _m6809.u + 6 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x47:
                ea = _m6809.u + 7 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x48:
                ea = _m6809.u + 8 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x49:
                ea = _m6809.u + 9 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4a:
                ea = _m6809.u + 10 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4b:
                ea = _m6809.u + 11 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4c:
                ea = _m6809.u + 12 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4d:
                ea = _m6809.u + 13 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4e:
                ea = _m6809.u + 14 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x4f:
                ea = _m6809.u + 15 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;

            case 0x50:
                ea = _m6809.u - 16 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x51:
                ea = _m6809.u - 15 & 0xFFFF;
            ...
            case 0x60:
                ...
                break;
            case 0x61:
                ea = _m6809.s + 1 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x62:
                ea = _m6809.s + 2 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x63:
                ea = _m6809.s + 3 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x64:
                ea = _m6809.s + 4 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x65:
                ea = _m6809.s + 5 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x66:
                ea = _m6809.s + 6 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x67:
                ea = _m6809.s + 7 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x68:
                ea = _m6809.s + 8 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x69:
                ea = _m6809.s + 9 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6a:
                ea = _m6809.s + 10 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6b:
                ea = _m6809.s + 11 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6c:
                ea = _m6809.s + 12 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6d:
                ea = _m6809.s + 13 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6e:
                ea = _m6809.s + 14 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x6f:
                ea = _m6809.s + 15 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;

            case 0x70:
                ea = _m6809.s - 16 & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0x71:
                ea = _m6809.s - 15 & 0xFFFF;
            ...
            case 0x80:
                ea = _m6809.x & 0xFFFF;
                _m6809.x = (char) (_m6809.x + 1);
                m6809_ICount[0] -= 2;
                break;
            case 0x81:
                ea = _m6809.x & 0xFFFF;
                _m6809.x = (char) (_m6809.x + 2);
                m6809_ICount[0] -= 3;
                break;
            case 0x82:
                _m6809.x = (char) (_m6809.x - 1);
            ...
            case 0x84:
                ...
                break;
            case 0x85:
                ea = (_m6809.x + (byte) _m6809.b) & 0xFFFF;/*EA=X+SIGNED(B);*/ m6809_ICount[0] -= 1;
                break;
            case 0x86:
                ea = (_m6809.x + (byte) _m6809.a) & 0xFFFF;/*EA=X+SIGNED(A);*/ m6809_ICount[0] -= 1;
                break;
            /*TODO*///	case 0x87: EA=0;																   break; /*   ILLEGAL*/
            case 0x88:
                ea = IMMBYTE();
                ea = _m6809.x + (byte) ea & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            /* this is a hack to make Vectrex work. It should be m6809_ICount[0]-=1. Dunno where the cycle was lost :( */
            case 0x89:
                ea = IMMWORD();
                ea = ea + _m6809.x & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            /*TODO*///	case 0x8a: EA=0;																   break; /*   ILLEGAL*/
            case 0x8b:
                ea = _m6809.x + _opcodes.getDreg() & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            /*TODO*///	case 0x8c: IMMBYTE(EA); 	EA=PC+SIGNED(EA);					m6809_ICount[0]-=1;   break;
            case 0x8d:
                ea = IMMWORD();
                ea = ea + _m6809.pc & 0xFFFF;
                m6809_ICount[0] -= 5;
                break;
            ...
            case 0x94:
                ...
                break;
            case 0x95:
                ea = _m6809.x + (byte) _m6809.b & 0xFFFF;
                ea = RM16(ea);
                m6809_ICount[0] -= 4;
                break;
            case 0x96:
                ea = _m6809.x + (byte) _m6809.a & 0xFFFF;
                ea = RM16(ea);
                m6809_ICount[0] -= 4;
                break;
            ...
            case 0xa0:
                ea = _m6809.y & 0xFFFF;
                _m6809.y = (char) (_m6809.y + 1);
                m6809_ICount[0] -= 2;
                break;
            case 0xa1:
                ea = _m6809.y & 0xFFFF;
                _m6809.y = (char) (_m6809.y + 2);
                m6809_ICount[0] -= 3;
                break;
            case 0xa2:
                _m6809.y = (char) (_m6809.y - 1);
            ...
            case 0xa4:
                ...
                break;
            case 0xa5:
                ea = _m6809.y + (byte) _m6809.b & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xa6:
                ea = _m6809.y + (byte) _m6809.a & 0xFFFF;/*EA=Y+SIGNED(A);*/ m6809_ICount[0] -= 1;
                break;
            /*TODO*///	case 0xa7: EA=0;																   break; /*   ILLEGAL*/
            case 0xa8:
                ea = IMMBYTE();
                ea = _m6809.y + (byte) ea & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xa9:
                ea = IMMWORD();
                ea = ea + _m6809.y & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            /*TODO*///	case 0xaa: EA=0;																   break; /*   ILLEGAL*/
            case 0xab:
                ea = _m6809.y + _opcodes.getDreg() & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            ...
            case 0xb5:
                ...
                break;
            case 0xb6:
                ea = _m6809.y + (byte) _m6809.a & 0xFFFF;
                ea = RM16(ea);
                m6809_ICount[0] -= 4;
                break;
            ...
            case 0xc4:
                ...
                break;
            case 0xc5:
                ea = _m6809.u + (byte) _m6809.b & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xc6:
                ea = _m6809.u + (byte) _m6809.a & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            /*TODO*///	case 0xc7: EA=0;																   break; /*ILLEGAL*/
            case 0xc8:
                ea = IMMBYTE();
                ea = _m6809.u + (byte) ea & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xc9:
                ea = IMMWORD();
                ea = ea + _m6809.u & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            /*TODO*///	case 0xca: EA=0;																   break; /*ILLEGAL*/
            case 0xcb:
                ea = _m6809.u + _opcodes.getDreg() & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
            ...
            case 0xe4:
                ...
                break;
            case 0xe5:
                ea = _m6809.s + (byte) _m6809.b & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xe6:
                ea = _m6809.s + (byte) _m6809.a & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            /*TODO*///	case 0xe7: EA=0;																   break; /*ILLEGAL*/
            case 0xe8:
                ea = IMMBYTE();
                ea = _m6809.s + (byte) ea & 0xFFFF;
                m6809_ICount[0] -= 1;
                break;
            case 0xe9:
                ea = IMMWORD();
                ea = (ea + _m6809.s) & 0xFFFF;
                m6809_ICount[0] -= 4;
                break;
