...
public class _6821pia {
    ...
    public static void update_6821_interrupts(pia6821 p) {
        ...
        /* start with IRQ A */
        new_state = 0;
        if ((p.irq_a1 != 0 && IRQ1_ENABLED(p.ctl_a)) || (p.irq_a2 != 0 && IRQ2_ENABLED(p.ctl_a))) {
            new_state = 1;
        }
        ...
        /* then do IRQ B */
        new_state = 0;
        if ((p.irq_b1 != 0 && IRQ1_ENABLED(p.ctl_b)) || (p.irq_b2 != 0 && IRQ2_ENABLED(p.ctl_b))) {
            new_state = 1;
        }
    ...
    public static int pia_read(int which, int offset) {
        ...
        offset &= 3;
        if ((p.addr & PIA_ALTERNATE_ORDERING) != 0) {
        ...
        switch (offset) {
            ...
            case PIA_DDRA:
                ...
                if (OUTPUT_SELECTED(p.ctl_a)) {
                    ...
                    val = (p.out_a & p.ddr_a) + (p.in_a & (~p.ddr_a & 0xFF));
            ...
            case PIA_DDRB:
                ...
                if (OUTPUT_SELECTED(p.ctl_b)) {
                    /* update the input */
                    if (p.intf.in_b_func != null) {
                        p.in_b = (char) (p.intf.in_b_func.handler(0) & 0xFF);
                    }

                    /* combine input and output values */
                    val = (p.out_b & p.ddr_b) + (p.in_b & (~p.ddr_b & 0xFF));
            ...
            case PIA_CTLA:
                ...
                if (p.irq_a2 != 0 && C2_INPUT(p.ctl_a)) {
                    val |= PIA_IRQ2;
                }
            ...
            case PIA_CTLB:
                ...
                if (p.intf.in_cb1_func != null) {
                    pia_set_input_cb1.handler(which, p.intf.in_cb1_func.handler(0));
                }
                if (p.intf.in_cb2_func != null) {
                    pia_set_input_cb2.handler(which, p.intf.in_cb2_func.handler(0));
                }
                ...
                if (p.irq_b2 != 0 && C2_INPUT(p.ctl_b)) {
                    val |= PIA_IRQ2;
                }
                    ...
                    if (C2_OUTPUT(p.ctl_b) && C2_STROBE_MODE(p.ctl_b)) {
                        ...
                        if (p.out_cb2 != 0) {
                            if (p.intf.out_cb2_func != null) {
                                p.intf.out_cb2_func.handler(0, 0);
                            }
                        }
                        p.out_cb2 = 0;
 ...
 /* 10/22/98 - MAB/FMP - any C2_OUTPUT should affect CB2 */
     ...
     */
    public static WriteHandlerPtr pia_set_input_a = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
     ...
     * ******************
     */
    public static WriteHandlerPtr pia_set_input_ca1 = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
     ...
     * ******************
     */
    public static WriteHandlerPtr pia_set_input_ca2 = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
     ...
     */
    public static WriteHandlerPtr pia_set_input_b = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
     ...
     * ******************
     */
    public static WriteHandlerPtr pia_set_input_cb1 = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
                ...
                if ((data != 0 && C1_LOW_TO_HIGH(p.ctl_b)) || (data == 0 && C1_HIGH_TO_LOW(p.ctl_b))) {
                    ...
                    if (C2_OUTPUT(p.ctl_b) && C2_STROBE_MODE(p.ctl_b) && STROBE_C1_RESET(p.ctl_b)) {
                        ...
                        if (p.irq_b1 == 0) {
                            ...
                            if (p.out_cb2 == 0) {
                                if (p.intf.out_cb2_func != null) {
                                    p.intf.out_cb2_func.handler(0, 1);
                                }
                            }
     ...
     * ******************
     */
    public static WriteHandlerPtr pia_set_input_cb2 = new WriteHandlerPtr() {
        public void handler(int which, int data) {
            pia6821 p = pia[which];
