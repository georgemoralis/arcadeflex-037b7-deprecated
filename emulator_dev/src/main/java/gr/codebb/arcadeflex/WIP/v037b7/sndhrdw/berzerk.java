...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.berzerk.berzerkplayvoice;
...
public class berzerk
{
	...
	public static ShStartPtr berzerk_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	{
		berzerkplayvoice = sample_playing(VOICE_CHANNEL)!=0?0:1;
