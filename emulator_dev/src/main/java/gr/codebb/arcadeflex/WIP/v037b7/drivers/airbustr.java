...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.okim6295.*;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.airbustr.*;
...
public class airbustr
{
	...
	static UBytePtr devram=new UBytePtr(), sharedram=new UBytePtr();
	...
	*/
	...
	public static ReadHandlerPtr sharedram_r  = new ReadHandlerPtr() { public int handler(int offset)	{ return sharedram.read(offset); } };
	public static WriteHandlerPtr sharedram_w = new WriteHandlerPtr() {public void handler(int offset, int data)	{ sharedram.write(offset, data); } };
	...
	public static WriteHandlerPtr devram_w = new WriteHandlerPtr() {public void handler(int offset, int data)	{	devram.write(offset, data); } };
